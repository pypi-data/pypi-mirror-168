...
import yaml
import sys
from opsrampcli import argparsing, opsrampenv, alerts, incidents, resources, discovery, monitoring, escalationpolicies, customattrs, servicemaps
...
def main():
    ...
    if hasattr(args, 'env') and args.env:
        ...
        env['tenant'] = args.tenant
        env['partner'] = args.partner
        env['vtoken'] = args.vtoken
        ops = opsrampenv.OpsRampEnv(env, args.secure)
