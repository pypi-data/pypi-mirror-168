...
from mun_official.core.filter import Filter
import mun_official.core.reducer as reducer

class RubberBand(object):
    """Core object within the mun_official library. It is responsible for
