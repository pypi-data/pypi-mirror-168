...
class EasyPaint(ABC):
    ...
    def create_rectangle(self, x1: float, y1: float, x2: float, y2: float, color: str = 'black', fill=None, **args):
        ...
        try:
            ...
            raise EasyPaintException("Wrong coordinates in {fn}: {(x1, y1, x2, y2)}")
    ...
    def create_polygon(self, *params, color: str = 'black', fill=None, **args):
        """Draws a polygon
        ...
        try:
            ...
            raise EasyPaintException("Wrong coordinates in create_polygon: {*params}")
        try:
            return self._canvas.create_polygon(*params2, **args)
        except:
            raise EasyPaintException("create_polygon")

    def create_filled_polygon(self, *params, color='black', fill=None, **args):
        ...
        if self.closing: return
        if fill is None: fill = color
        return self.create_polygon(*params, color, fill, **args)
    ...
    def create_point(self, x: float, y: float, color: str = 'black', **args):
        ...
        try:
            ...
            raise EasyPaintException("Wrong coordinates in create_point: {(x, y)}")
        try:
    ...
    def create_line(self, x1: float, y1: float, x2: float, y2: float, color: str = 'black', **args):
        ...
        try:
            ...
            raise EasyPaintException("Wrong coordinates in create_line: {(x1, y1, x2, y2)}")
        try:
    ...
    def create_text(self, x: float, y: float, text: str, font_size: int = 10,
        ...
        try:
            ...
            raise EasyPaintException("Wrong coordinates in create_text: {(x, y)}")
        try:
        ...
        if param is None:  # Delete all elements
            ...
            if len(param) > 0:
                try:
                    ...
                    raise EasyPaintException("Wrong id in erase: {param}")
    ...
    def move(self, tags, x: float, y: float):
        ...
        try:
            ...
            raise EasyPaintException("Wrong coordinates in move: x={x}, y={y}")
        try:
