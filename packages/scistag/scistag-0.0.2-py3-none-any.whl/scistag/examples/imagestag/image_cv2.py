"""
Simple demo which loads an image from Wikipedia using WebStag, loads it via ImageStag and displays it in a TKInter
window. In addition it applies a classic OpenCv2 filter
"""
