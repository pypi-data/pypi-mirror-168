...
class DataStagElement:
    ...
    def __init__(self, vault):
        ...
        self.name: Optional[str] = None  # The element's name
        self.parent: Optional["DataStagElement"] = None  # The parent element (e.g. a list containing the element)
        self.deprecation_time: Optional[float] = None  # Time when this element shall be destroyed
        self.version_counter: int = 0  # The element's update counter

    def set_value(self, value: StagDataTypes, deprecation_time: Optional[float] = None):
        """
