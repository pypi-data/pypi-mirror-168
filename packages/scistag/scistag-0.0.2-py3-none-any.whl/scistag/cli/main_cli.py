...
#    python3 -m scistag demo      Get an overview of all bundled demos
        ...
        subparsers = parser.add_subparsers(
            ...
            metavar='command')
        subparsers.add_parser("info", help="Show info about the module and integrated plugins")
        subparsers.add_parser("demo", help="Execute or view the source code of a feature demo")
        args = parser.parse_args(sys.argv)

    @staticmethod
    def demo(self):
        from scistag.cli.cli_demo import SciStagDemoCli
        demo_cli = SciStagDemoCli(sys.argv[2:])
