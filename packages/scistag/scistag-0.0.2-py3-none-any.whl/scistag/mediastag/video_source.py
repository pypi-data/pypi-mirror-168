...
class VideoSource:
    ...
    def set_filter(self, image_filter: Optional[ImageFilter]) -> None:
        """
    ...
    def get_image(self, timestamp: Optional[float] = None) -> Tuple[float, Optional[Image]]:
        """
