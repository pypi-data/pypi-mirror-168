"""
Simple demo which loads an image from Wikipedia and applies different filters
"""
...
def main():
    ...
    img3 = ImageTk.PhotoImage(ColorMapFilter(color_map="viridis").filter(image).to_pil())
