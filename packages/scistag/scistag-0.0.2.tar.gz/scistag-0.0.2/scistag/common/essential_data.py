...
from scistag.common.configuration import ESSENTIAL_DATA_URL, ESSENTIAL_DATA_ARCHIVE_NAME, ESSENTIAL_DATA_MD5, \
    ESSENTIAL_DATA_SIZE
import hashlib
...
def verify_data(identifier, archive_name, source_url, exp_size, exp_md5, quick=False) -> bool:
    """
    ...
    if invalid_filesize:
        logging.warning(f"Data file {archive_name} is invalid. Removing and re-downloading it.")
...
def verify_essential_data(quick=False) -> bool:
    ...
    """
    return \
        verify_data(identifier="scistagessential", archive_name=ESSENTIAL_DATA_ARCHIVE_NAME,
