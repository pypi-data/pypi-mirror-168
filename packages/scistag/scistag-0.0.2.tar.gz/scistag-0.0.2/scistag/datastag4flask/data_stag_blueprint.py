...
class DataStagService(Blueprint):
    ...
    def __init__(self):
        ...
        Initializer
        """
        super().__init__("DataStag", __name__, template_folder="./templates", static_folder="./static")
...
def handle_run():
    """
    Execution function. Converts all commands provided as a JSON object or list of JSON object to local Vault
    commands and returns their data
    """
    try:
        ...
        current_app.logger.error("An error occurred during the execution of a DataStag request")
