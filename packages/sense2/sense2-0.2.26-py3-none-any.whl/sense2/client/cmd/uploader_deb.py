...
class CmdUploadDeb(CmdUpload):
    ...
    def _upload_deb(self, pref, retry=None, retry_wait=None, integrity_check=False,
        ...
        assert (not conanfile.apt_user), "apt_user is not defined or empty in conanfile.py."
        assert (not conanfile.apt_server), "apt_server is not defined or empty in conanfile.py."
