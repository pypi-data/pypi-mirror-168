...
class Commands:
    ...
    def generate(self):
        try:
            _dir = os.getcwd()
            _res = requests.post('https://api.clix.dev/api/package/generate',
            data=json.dumps({
    ...
    def sync(self):
        try:
            _res = requests.post('https://api.clix.dev/api/package/sync',
                                data=json.dumps({
                                    'terminal_token': self.terminal_token,
                                    'project_token': self.project_token,
                                })).json()
    ...
    def docs(self):
        try:
            _res = requests.post('https://api.clix.dev/api/package/docs',
                                data=json.dumps({
                                    'terminal_token': self.terminal_token,
                                    'project_token': self.project_token,
                                })).json()
