...
from trace import MANAGE, REQUIREMENTS, WSGI, URLS, SETTINGS, VIEWS, MODELS, APP_URLS, ADMIN, README
...
def sync(terminal_token, project_token, *args):
    # with open('../../../project_1/project_1/clix.json', 'w') as w:
    #     w.write(json.dumps(res['apps']))
    # return
