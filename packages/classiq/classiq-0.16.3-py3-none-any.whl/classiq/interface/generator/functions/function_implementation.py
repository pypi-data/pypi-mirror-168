...
class FunctionImplementation(BaseModel):
    ...
    def num_qubits_in_all_registers(self, interface: FunctionInterfaceData) -> int:
        all_input_registers = (
            interface.input_registers
            + interface.zero_input_registers
    ...
    def validate_ranges_of_all_registers(
        self, interface: FunctionInterfaceData
    ) -> None:
        input_registers = interface.input_registers
        output_registers = interface.output_registers
        zero_input_registers = interface.zero_input_registers
