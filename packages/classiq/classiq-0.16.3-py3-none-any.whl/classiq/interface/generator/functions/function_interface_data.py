...
class FunctionInterfaceData(pydantic.BaseModel):
    ...
    def validate_interface(cls, values: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def validate_equal_interfaces(self, other: FunctionInterfaceData):
        if any(
            [
