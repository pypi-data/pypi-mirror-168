...
(e.g., operating system, Python version, docker image version) and steps to reproduce the problem.
...
[repository]: https://github.com/<USERNAME>/certdeploy
[issue tracker]: https://github.com/<USERNAME>/certdeploy/issues
