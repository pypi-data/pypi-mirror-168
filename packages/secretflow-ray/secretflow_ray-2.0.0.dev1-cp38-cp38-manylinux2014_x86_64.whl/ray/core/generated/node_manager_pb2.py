...
_REQUESTWORKERLEASEREPLY_SCHEDULINGFAILURETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SCHEDULING_CANCELLED_UNSCHEDULABLE', index=5, number=5,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_PINOBJECTIDREQUEST = _descriptor.Descriptor(
  name='PinObjectIDRequest',
  full_name='ray.rpc.PinObjectIDRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='owner_address', full_name='ray.rpc.PinObjectIDRequest.owner_address', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='object_ids', full_name='ray.rpc.PinObjectIDRequest.object_ids', index=1,
...
_PINOBJECTIDREPLY = _descriptor.Descriptor(
  name='PinObjectIDReply',
  full_name='ray.rpc.PinObjectIDReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_GETTASKSINFOREQUEST = _descriptor.Descriptor(
  name='GetTasksInfoRequest',
  full_name='ray.rpc.GetTasksInfoRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_GETTASKSINFOREPLY = _descriptor.Descriptor(
  name='GetTasksInfoReply',
  full_name='ray.rpc.GetTasksInfoReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='task_info_entries', full_name='ray.rpc.GetTasksInfoReply.task_info_entries', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETOBJECTSINFOREQUEST = _descriptor.Descriptor(
  name='GetObjectsInfoRequest',
  full_name='ray.rpc.GetObjectsInfoRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_GETOBJECTSINFOREPLY = _descriptor.Descriptor(
  name='GetObjectsInfoReply',
  full_name='ray.rpc.GetObjectsInfoReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='core_workers_stats', full_name='ray.rpc.GetObjectsInfoReply.core_workers_stats', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETRESOURCELOADREQUEST = _descriptor.Descriptor(
  name='GetResourceLoadRequest',
  full_name='ray.rpc.GetResourceLoadRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_GETRESOURCELOADREPLY = _descriptor.Descriptor(
  name='GetResourceLoadReply',
  full_name='ray.rpc.GetResourceLoadReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resources', full_name='ray.rpc.GetResourceLoadReply.resources', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PINOBJECTIDREQUEST.fields_by_name['owner_address'].message_type = src_dot_ray_dot_protobuf_dot_common__pb2._ADDRESS
...
_GETTASKSINFOREPLY.fields_by_name['task_info_entries'].message_type = src_dot_ray_dot_protobuf_dot_common__pb2._TASKINFOENTRY
_GETOBJECTSINFOREPLY.fields_by_name['core_workers_stats'].message_type = src_dot_ray_dot_protobuf_dot_common__pb2._COREWORKERSTATS
_GETRESOURCELOADREPLY.fields_by_name['resources'].message_type = src_dot_ray_dot_protobuf_dot_gcs__pb2._RESOURCESDATA
...
DESCRIPTOR.message_types_by_name['PinObjectIDRequest'] = _PINOBJECTIDREQUEST
DESCRIPTOR.message_types_by_name['PinObjectIDReply'] = _PINOBJECTIDREPLY
...
DESCRIPTOR.message_types_by_name['GetTasksInfoRequest'] = _GETTASKSINFOREQUEST
DESCRIPTOR.message_types_by_name['GetTasksInfoReply'] = _GETTASKSINFOREPLY
DESCRIPTOR.message_types_by_name['GetObjectsInfoRequest'] = _GETOBJECTSINFOREQUEST
DESCRIPTOR.message_types_by_name['GetObjectsInfoReply'] = _GETOBJECTSINFOREPLY
DESCRIPTOR.message_types_by_name['GetResourceLoadRequest'] = _GETRESOURCELOADREQUEST
DESCRIPTOR.message_types_by_name['GetResourceLoadReply'] = _GETRESOURCELOADREPLY
...
PinObjectIDRequest = _reflection.GeneratedProtocolMessageType('PinObjectIDRequest', (_message.Message,), {
  'DESCRIPTOR' : _PINOBJECTIDREQUEST,
  '__module__' : 'src.ray.protobuf.node_manager_pb2'
  # @@protoc_insertion_point(class_scope:ray.rpc.PinObjectIDRequest)
  })
_sym_db.RegisterMessage(PinObjectIDRequest)

PinObjectIDReply = _reflection.GeneratedProtocolMessageType('PinObjectIDReply', (_message.Message,), {
  'DESCRIPTOR' : _PINOBJECTIDREPLY,
  '__module__' : 'src.ray.protobuf.node_manager_pb2'
  # @@protoc_insertion_point(class_scope:ray.rpc.PinObjectIDReply)
  })
_sym_db.RegisterMessage(PinObjectIDReply)
...
_NODEMANAGERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetResourceLoad',
    full_name='ray.rpc.NodeManagerService.GetResourceLoad',
    index=1,
    containing_service=None,
    input_type=_GETRESOURCELOADREQUEST,
    output_type=_GETRESOURCELOADREPLY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='PinObjectID',
    full_name='ray.rpc.NodeManagerService.PinObjectID',
    index=12,
    containing_service=None,
    input_type=_PINOBJECTIDREQUEST,
    output_type=_PINOBJECTIDREPLY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetTasksInfo',
    full_name='ray.rpc.NodeManagerService.GetTasksInfo',
    index=20,
    containing_service=None,
    input_type=_GETTASKSINFOREQUEST,
    output_type=_GETTASKSINFOREPLY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetObjectsInfo',
    full_name='ray.rpc.NodeManagerService.GetObjectsInfo',
    index=21,
    containing_service=None,
    input_type=_GETOBJECTSINFOREQUEST,
    output_type=_GETOBJECTSINFOREPLY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
