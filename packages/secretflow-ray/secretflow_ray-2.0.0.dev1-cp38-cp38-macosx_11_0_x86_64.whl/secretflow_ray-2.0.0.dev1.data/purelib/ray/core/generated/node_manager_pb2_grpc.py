...
class NodeManagerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PinObjectID = channel.unary_unary(
                '/ray.rpc.NodeManagerService/PinObjectID',
                request_serializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.PinObjectIDRequest.SerializeToString,
                response_deserializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.PinObjectIDReply.FromString,
                )
...
class NodeManagerServiceServicer(object):
    ...
    def PinObjectID(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_NodeManagerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'PinObjectID': grpc.unary_unary_rpc_method_handler(
                    servicer.PinObjectID,
                    request_deserializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.PinObjectIDRequest.FromString,
                    response_serializer=src_dot_ray_dot_protobuf_dot_node__manager__pb2.PinObjectIDReply.SerializeToString,
            ),
...
class NodeManagerService(object):
    ...
    def PinObjectID(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ray.rpc.NodeManagerService/PinObjectID',
            src_dot_ray_dot_protobuf_dot_node__manager__pb2.PinObjectIDRequest.SerializeToString,
            src_dot_ray_dot_protobuf_dot_node__manager__pb2.PinObjectIDReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
