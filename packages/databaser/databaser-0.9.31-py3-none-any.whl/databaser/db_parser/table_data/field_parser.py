...
class FieldParser:
    ...
    def parse(self):
        ...
        for field in self.fields:
            ...
            if not in_function_parameters.__contains__(","):
                field = field_split[-1].strip()
            ...
            # field = f"{f}({field})" if f != "" else field
                ...
                for param in in_function_parameters.split(","):
                    ...
                    if not param.__contains__("'"):
                        ...
                        table_name = param_split[-2] if param.__contains__(".") and param_split.__len__() in [2,3] \
                            else self.table_name
                        print("Table Name:", table_name, )

                        schema_name = param.split(".")[-3] if param.__contains__(".") and param_split.__len__() in [3] \
