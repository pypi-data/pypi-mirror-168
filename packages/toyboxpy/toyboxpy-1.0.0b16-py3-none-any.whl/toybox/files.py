...
class Files:
    ...
    @classmethod
    def generateLuaIncludeFile(cls, dependencies):
        lua_includes = []
    ...
    @classmethod
    def generateMakefile(cls, dependencies):
        makefiles = []
    ...
    @classmethod
    def generateIncludeFile(cls, dependencies):
        include_files = []
    ...
    @classmethod
    def generateReadMeFileIn(cls, folder):
