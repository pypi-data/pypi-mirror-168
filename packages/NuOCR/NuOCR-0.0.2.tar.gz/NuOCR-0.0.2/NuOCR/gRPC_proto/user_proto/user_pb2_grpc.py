...
from gRPC_proto.user_proto import user_pb2 as user__proto_dot_user__pb2
...
class UserControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddAccess = channel.unary_unary(
                ...
                request_serializer=user__proto_dot_user__pb2.UserRequest.SerializeToString,
                response_deserializer=user__proto_dot_user__pb2.User.FromString,
                )
...
def add_UserControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AddAccess': grpc.unary_unary_rpc_method_handler(
                    servicer.AddAccess,
                    request_deserializer=user__proto_dot_user__pb2.UserRequest.FromString,
                    response_serializer=user__proto_dot_user__pb2.User.SerializeToString,
            ),
...
class UserController(object):
    ...
    def AddAccess(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/user_proto.UserController/AddAccess',
            user__proto_dot_user__pb2.UserRequest.SerializeToString,
            user__proto_dot_user__pb2.User.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
