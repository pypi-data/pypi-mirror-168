...
from gRPC_proto.io_adaptors_APIs_proto import io_adaptors_pb2 as io__adaptors__APIs__proto_dot_io__adaptors__pb2
...
class IOAdaptorControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FTPInBound = channel.unary_stream(
                ...
                request_serializer=io__adaptors__APIs__proto_dot_io__adaptors__pb2.FTPRequest.SerializeToString,
                response_deserializer=io__adaptors__APIs__proto_dot_io__adaptors__pb2.InBoundResponse.FromString,
                )
        self.FTPOutBound = channel.unary_unary(
                '/io_adaptors_APIs_proto.IOAdaptorController/FTPOutBound',
                request_serializer=io__adaptors__APIs__proto_dot_io__adaptors__pb2.FTPRequest.SerializeToString,
                response_deserializer=io__adaptors__APIs__proto_dot_io__adaptors__pb2.OutBoundResponse.FromString,
                )
        self.S3InBound = channel.unary_stream(
                '/io_adaptors_APIs_proto.IOAdaptorController/S3InBound',
                request_serializer=io__adaptors__APIs__proto_dot_io__adaptors__pb2.S3Request.SerializeToString,
                response_deserializer=io__adaptors__APIs__proto_dot_io__adaptors__pb2.InBoundResponse.FromString,
                )
...
def add_IOAdaptorControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'FTPInBound': grpc.unary_stream_rpc_method_handler(
                    servicer.FTPInBound,
                    request_deserializer=io__adaptors__APIs__proto_dot_io__adaptors__pb2.FTPRequest.FromString,
                    response_serializer=io__adaptors__APIs__proto_dot_io__adaptors__pb2.InBoundResponse.SerializeToString,
            ),
            'FTPOutBound': grpc.unary_unary_rpc_method_handler(
                    servicer.FTPOutBound,
                    request_deserializer=io__adaptors__APIs__proto_dot_io__adaptors__pb2.FTPRequest.FromString,
                    response_serializer=io__adaptors__APIs__proto_dot_io__adaptors__pb2.OutBoundResponse.SerializeToString,
            ),
            'S3InBound': grpc.unary_stream_rpc_method_handler(
                    servicer.S3InBound,
                    request_deserializer=io__adaptors__APIs__proto_dot_io__adaptors__pb2.S3Request.FromString,
                    response_serializer=io__adaptors__APIs__proto_dot_io__adaptors__pb2.InBoundResponse.SerializeToString,
            ),
...
class IOAdaptorController(object):
    ...
    def FTPInBound(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/io_adaptors_APIs_proto.IOAdaptorController/FTPInBound',
            io__adaptors__APIs__proto_dot_io__adaptors__pb2.FTPRequest.SerializeToString,
            io__adaptors__APIs__proto_dot_io__adaptors__pb2.InBoundResponse.FromString,
    ...
    def FTPOutBound(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/io_adaptors_APIs_proto.IOAdaptorController/FTPOutBound',
            io__adaptors__APIs__proto_dot_io__adaptors__pb2.FTPRequest.SerializeToString,
            io__adaptors__APIs__proto_dot_io__adaptors__pb2.OutBoundResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def S3InBound(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/io_adaptors_APIs_proto.IOAdaptorController/S3InBound',
            io__adaptors__APIs__proto_dot_io__adaptors__pb2.S3Request.SerializeToString,
            io__adaptors__APIs__proto_dot_io__adaptors__pb2.InBoundResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
