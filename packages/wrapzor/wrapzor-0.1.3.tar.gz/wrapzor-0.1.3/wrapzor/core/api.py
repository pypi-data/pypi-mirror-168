...
from wrapzor.errors.api import Message
from wrapzor.logs import logs
from wrapzor.utils import clean_domain, top_level_domain
...
class Api:
    ...
    tokens_path: Path = Path(__file__).parent.parent.parent / "static" / "tokens"
