...
@inject_tokens()
async def get_from_addresses(client: AsyncClient, api: Api) -> Response:
...
@inject_tokens()
async def send_mail(module: str, record_id: str, data: dict, client: AsyncClient, api: Api) -> Response:
