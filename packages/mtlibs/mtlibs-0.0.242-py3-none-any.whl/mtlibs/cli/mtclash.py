...
EXTERNAL_PROXY_HOST=os.environ.get("EXTERNAL_PROXY_HOST")
EXTERNAL_PROXY_PORT=os.environ.get("EXTERNAL_PROXY_PORT")
CLASH_DEFAULT_DNS=os.environ.get("CLASH_DEFAULT_DNS")
...
def start_clash():
    ...
    clash_config_path = clash_config() # str(Path(__file__).parent.parent.joinpath("data/clash/config-tproxy.yml"))
