...
class AliCli:
    ...
    def __init__(self, accessKeyId=None, accessKeySecret=None, regionIds=['cn-shenzhen']) -> None:
        super().__init__()
...
class Ecs:
    ...
    def __init__(self, regionId=None,hostname=None, tags=[], privateIpAddress=None, description=None) -> None:
        super().__init__()
...
def get_default_ecs():
    ...
    cli = AliCli(ado_ini.read_cfg_item(section=default_section, key='accesskeyid'),
                 ado_ini.read_cfg_item(section=default_section, key='accesskeysecret'),
                 ado_ini.read_cfg_item(section=default_section, key='regionids').split(','))
...
if __name__ == '__main__':
    ...
    print([ecs.ip for ecs in ecsClient.ecses_iterator()])
    pass
