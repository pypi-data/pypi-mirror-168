...
class ClientMainWindow(QMainWindow):
    ...
    def __init__(self, database, transport, keys):
        ...
        # объект - дешифровщик сообщений с предзагруженным клюём
    ...
    def message(self, message):
        """
        Слот обработчик поступаемые сообщений, выполняет дешифровку
        поступаемые сообщений и их сохранение в истории сообщений.
