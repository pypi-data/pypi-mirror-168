"""
Many thanks to GitHub @neurowookie, asasdasd
...
class BorisAppender(object):
    ...
    def append_boris(self):
        """
        Method to append BORIS annotations creatpython setup.py sdist bdist_wheeled in :func:`~simba.BorisAppender.create_boris_master_file` to the
