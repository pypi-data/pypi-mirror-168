...
def create_probability_plots(frm_range: list,
                             data: list,
                             clf_name: str,
                             highest_p: float,
                             fps: int,
    ...
    def create_plot(self):
        ...
        for file_cnt, file_path in enumerate(self.files_found):
            ...
            with multiprocessing.Pool(self.cpu_to_use, maxtasksperchild=self.maxtasksperchild) as pool:
                functools.partial(create_probability_plots, b=self.probability_lst)
                constants = functools.partial(create_probability_plots,
