...
def get_ec2_resource():
    """
    :return: An EC2 resource using the default region.
    """
    return boto3.resource('ec2', _region)


def get_autoscaling():
    """
    :return: An autoscaling client using the default region.
    """
    return boto3.client('autoscaling', _region)
