...
class ProbeService:
    ...
    def __init__(self, endpoint_token=None, account_id=os.getenv('PRELUDE_ACCOUNT_ID'), account_secret=os.getenv('PRELUDE_ACCOUNT_SECRET')):
        self.token = endpoint_token
