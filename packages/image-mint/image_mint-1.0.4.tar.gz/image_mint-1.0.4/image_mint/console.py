...
def main():
    ...
    parser.add_argument("-e", "--engine", required=False, default="Google",
                        choices=['Google', 'Bing', 'DogPile', 'Yahoo', 'DuckDuckGo'],
                        help="Which search engine should be used? (DogPile/Bing/Google/DuckDuckGo/Yahoo)")
    parser.add_argument("-l", "--limit", help="Number of images to download.", type=int,
    ...
    parser.add_argument("-d", "--directory", help="Directory where to download the files",
                        default=None, required=True)
    parser.add_argument("-c", "--chrome_driver",
                        help="Path to Chrome driver executable. The driver can be Downloaded ",
                        default=None, required=True)
    parser.add_argument("-mw", "--min_width", help="Minimum acceptable image width",
                        type=int, default=None,
                        required=False)
    parser.add_argument("-mh", "--min_height", help="Minimum acceptable image height",
                        type=int, default=None,
                        required=False)
