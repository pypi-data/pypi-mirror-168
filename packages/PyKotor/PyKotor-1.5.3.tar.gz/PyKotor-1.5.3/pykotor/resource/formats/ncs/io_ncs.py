...
from pykotor.resource.formats.ncs.ncs_data import NCS, NCSInstruction, NCSByteCode, NCSInstructionType, \
    ...
    def _read_instruction(self) -> NCSInstruction:
        ...
        if instruction.ins_type in [NCSInstructionType.CPDOWNSP, NCSInstructionType.CPTOPSP,
            ...
            instruction.args.extend([self._reader.read_uint16(big=True),
                                     self._reader.read_uint8(big=True)])
        ...
        '''
        elif instruction.ins_type in [NCSInstructionType.NOP] or instruction.ins_type.value.byte_code.value in [
            NCSByteCode.RSADDx, NCSByteCode.RETN, NCSByteCode.EQUALxx. NCSByteCode.NEQUALxx, NCSByteCode.GTxx,
            NCSByteCode.LTxx
        ]:
            ...
            
        else:
            raise ValueError("Unsupported Instruction Type ", instruction.ins_type)
        '''
