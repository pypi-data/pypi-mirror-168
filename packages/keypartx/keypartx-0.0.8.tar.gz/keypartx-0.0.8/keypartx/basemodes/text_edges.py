...
try:
  ...
  print('Coreference is not available!!!')
...
#from autocorrect import Speller
#from collections import defaultdict
def target2edges(text,verbose = False, verbose_text= False,include_otherEdge = False, only_otherNouns = False,neg_words =neg_words,adjDEL = adjDEL,only_opiAV = True,nncompound = False):
  non_opi_adjs = negADJ(neg_words,adjDEL)
  # 1. check spelling 
