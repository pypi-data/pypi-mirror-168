...
# Change update rule of A (A = solve_Lasso_style(phi, data, l1, [], params = params, random_state = 0).flatten()) 
# to oscar (pyowl, https://github.com/vene/pyowl/blob/master/pyowl.py)
