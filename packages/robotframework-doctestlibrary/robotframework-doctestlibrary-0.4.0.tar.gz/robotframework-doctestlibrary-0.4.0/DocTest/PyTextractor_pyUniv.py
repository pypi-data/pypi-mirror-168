...
class PyTextractor:
    ...
    def decode_predictions(self, scores, geometry):
        ...
        for y in range(0, numRows):
            ...
            for x in range(0, numCols):
                ...
                # ignore it
                if scoresData[x] < self.confidence:
                    continue
    ...
    def get_image_text(self,
        ...
        #     gray_image, boxes, percentage, numbers, ratio_width, ratio_height
        # )
        ...
        for (startX, startY, endX, endY) in boxes:
            ...
            roi = threshold_image[startY:endY, startX:endX]
            import uuid
            cv2.imwrite(str(uuid.uuid4())+".png", roi)
