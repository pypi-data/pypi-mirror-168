...
private package Librflxlang.Debug is

   procedure PN (Node : Bare_RFLX_Node);
   ...
   procedure PT (Node : Bare_RFLX_Node);
   ...
   procedure PRel (Rel : Relation; Context_Node : Bare_RFLX_Node);
