...
class DbtImporter:
    ...
    @staticmethod
    def _load_dbt_run_results(dbt_run_results: Union[str, Dict]) -> Tuple[str, str, Dict]:
        ...
        try:
            return dbt_run_results.metadata.dbt_schema_version, dbt_run_results.metadata.invocation_id, dbt_run_results
        except KeyError:
    ...
    def import_run_results(self,
        ...
        """
        dbt_schema_version, _, run_results = self._load_dbt_run_results(dbt_run_results)
        response = self._mc_client(
    ...
    def upload_run_results(self,
        ...
        :param run_logs: dbt run log output to store with run (Optional)
        """
        dbt_schema_version, invocation_id, run_results = self._load_dbt_run_results(dbt_run_results)
