...
class BreezeConnect():
    ...
    def __init__(self, api_key):  # needed for hashing json data
        ...
        self.url = "https://directlink.icicidirect.com/NewSecurityMaster/SecurityMaster.zip"
...
class ApificationBreeze():
    ...
    def get_names(self, exchange_code, stock_code):
        try:
            ...
            required_file = self.zipfile.open(mapper_exchangecode_to_file.get(lexchange_code))
            ...
            requiredresult = df2[[' "ShortName"',' "ExchangeCode"','Token']]
