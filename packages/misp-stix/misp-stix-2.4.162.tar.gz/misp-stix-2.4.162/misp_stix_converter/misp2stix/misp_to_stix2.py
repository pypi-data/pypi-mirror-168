...
class MISPtoSTIX2Parser(MISPtoSTIXParser):
    ...
    def _handle_non_indicator_object(self, misp_object: Union[MISPObject, dict], object_args: dict, object_type: str, killchain: bool = False):
    ...
    def _handle_object_tags_and_galaxies(self, misp_object: Union[MISPObject, dict], object_id: str, timestamp: datetime) -> tuple:
