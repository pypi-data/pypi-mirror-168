...
class sto_framework():
    ...
    def setup(self):
        ...
        sql_queries['error_trained_model_repository'] = create_trained_model_repository(self.error_trained_model_repository)
        sql_queries['code_model_error_trained_model_view'] = create_code_model_trained_model_view(self.code_model_error_trained_model_view,
                                                                                            self.code_model_view,
    ...
    def create_feature_engineering_aggregate_process(self, id_process, id_mapper,  **kwargs):
       ...
       # create prepared dataset view
        ...
        feature_store_table_float,feature_store_table_integer,feature_store_table_varchar = create_features_table(self.feature_store.database,dataset_name.split('.')[-1]+'_AGG','aggregated')
        ...
        new_process = {
            ...
            'prepared_dataset': prepared_dataset_name,
            'on_clause': on_clause_view_name,
            'results': ','.join([feature_store_table_float,feature_store_table_integer,feature_store_table_varchar]),
            'error_results': self.error_trained_model_repository,
            'sto_database':self.SEARCHUIFDBPATH,
            'fold': 'all',
            'process_catalog':self.feature_store.process_catalog
    ...
    def create_feature_engineering_rowlevel_process(self, id_process, id_mapper, **kwargs):
       ...
       # create prepared dataset view
        ...
        feature_store_table_float, feature_store_table_integer, feature_store_table_varchar = create_features_table(
