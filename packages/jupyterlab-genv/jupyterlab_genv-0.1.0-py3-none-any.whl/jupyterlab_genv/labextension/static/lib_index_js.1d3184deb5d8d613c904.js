...
class DevicesWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_1__.Widget {
    async onUpdateRequest(_msg) {
        ...
        // this.div.innerText = 'raz';
        // for (const child of this.div.childNodes) {
...
const plugin = {
    ...
    activate: async (app, palette) => {
        ...
        devicesWidget.toolbar.insertItem(0, 'refresh', new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ToolbarButton({ label: 'Refresh', onClick: () => {
...
//# sourceMappingURL=lib_index_js.1d3184deb5d8d613c904.js.map