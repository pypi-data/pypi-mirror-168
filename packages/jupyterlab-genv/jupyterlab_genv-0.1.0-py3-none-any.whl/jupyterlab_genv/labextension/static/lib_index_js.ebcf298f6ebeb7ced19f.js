...
const plugin = {
    ...
    activate: async (app, palette) => {
        ...
        devicesWidget.toolbar.insertItem(0, 'refresh', new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ToolbarButton({ label: 'Refresh' }));
...
//# sourceMappingURL=lib_index_js.ebcf298f6ebeb7ced19f.js.map