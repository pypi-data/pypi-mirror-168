...
def fund_valuation_plot(date, pic_path):
    ...
    plt.title('估值分布（PE）', fontdict={'font': myfont, 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    ...
    plt.xticks(rotation=45)
    plt.gca().yaxis.set_major_formatter(FuncFormatter(to_100percent))
    plt.title('估值分布（PB）', fontdict={'font': myfont, 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
    ...
    plt.xticks(rotation=45)
    plt.title('平均估值差（PE）', fontdict={'font': myfont, 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
    ...
    plt.xticks(rotation=45)
    plt.title('核心资产估值溢价（PE）', fontdict={'font': myfont, 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
    ...
    plt.xticks(rotation=45)
    plt.title('核心资产估值溢价（PB）', fontdict={'font': myfont, 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
...
def fund_sector_plot(date, pic_path):
    ...
    plt.xticks(rotation=45)
    plt.gca().yaxis.set_major_formatter(FuncFormatter(to_100percent))
    ax.set_title('板块分布', fontdict={'font': myfont, 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
    ...
    ax1.set_ylabel('')
    ax2.set_ylabel('')
    plt.title('港股配置比例及估值', fontdict={'font': myfont, 'weight': 'bold', 'size': 16})
    plt.tight_layout()
...
def fund_theme_plot(date, pic_path):
    ...
    plt.xticks(rotation=45)
    plt.gca().yaxis.set_major_formatter(FuncFormatter(to_100percent))
    plt.title('主题分布', fontdict={'font': myfont, 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
...
def fund_industry_plot(date, pic_path, n=2, industry_name_1st='食品饮料'):
    ...
    plt.xlabel('')
    plt.ylabel('')
    plt.title('一级行业持仓统计', fontdict={'font': myfont, 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
    ...
    plt.xlabel('')
    plt.ylabel('')
    plt.title('一级行业持仓环比变化', fontdict={'font': myfont, 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
...
def fund_market_value_plot(date, pic_path):
    ...
    plt.title('成分股占比变化', fontdict={'font': myfont, 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
    ...
    plt.xticks(rotation=45)
    plt.gca().yaxis.set_major_formatter(FuncFormatter(to_100percent))
    plt.title('权重股占比变化', fontdict={'font': myfont, 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
...
def fund_style_plot(date, pic_path):
    ...
    plt.title('风格统计', fontdict={'font': myfont, 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=False, left=False, bottom=False)
    ...
    ax.plot(fund_style2_latest.index, fund_style2_latest['中盘成长'], color=new_color_list[0], alpha=0.67, label='中盘成长')
    ax.plot(fund_style2_latest.index, fund_style2_latest['小盘成长'], color=new_color_list[0], alpha=0.33, label='小盘成长')
    ax.plot(fund_style2_latest.index, fund_style2_latest['大盘平衡'], color=new_color_list[1], alpha=1.00, label='大盘平衡')
    ax.plot(fund_style2_latest.index, fund_style2_latest['中盘平衡'], color=new_color_list[1], alpha=0.67, label='中盘平衡')
    ax.plot(fund_style2_latest.index, fund_style2_latest['小盘平衡'], color=new_color_list[1], alpha=0.33, label='小盘平衡')
    ax.plot(fund_style2_latest.index, fund_style2_latest['大盘价值'], color=new_color_list[2], alpha=1.00, label='大盘价值')
    ax.plot(fund_style2_latest.index, fund_style2_latest['中盘价值'], color=new_color_list[2], alpha=0.67, label='中盘价值')
    ax.plot(fund_style2_latest.index, fund_style2_latest['小盘价值'], color=new_color_list[2], alpha=0.33, label='小盘价值')
    plt.legend(loc=8, bbox_to_anchor=(0.5, -0.3), ncol=5)
    ax.set_ylim([0.0, 0.5])
    # ax.set_ylim([0.0, 0.3])
    ax.yaxis.set_major_formatter(FuncFormatter(to_100percent))
    ax.set_xticklabels(labels=fund_style2_latest.index, rotation=45)
    plt.title('细分风格统计', fontdict={'font': myfont, 'weight': 'bold', 'size': 16})
    plt.tight_layout()
    sns.despine(top=True, right=True, left=False, bottom=False)
