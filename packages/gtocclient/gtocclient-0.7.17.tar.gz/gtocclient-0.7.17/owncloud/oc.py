...
class Client(object):
    ...
    def put_file(self, remote_path, local_source_file, **kwargs):
        ...
        if stat_result.st_size > 30*1024*1024*1024:
            raise InvalidFileError("Directly uploading files larger than 30G is not allowed. Please do chunked upload on this file instead.")
        if stat_result.st_size > 20*1024*1024*1024:
            print("Warn: Directly uploading files larger than 20G is not guaranteed to be stable. Please do chunked upload on this file instead.")
        headers = {}
