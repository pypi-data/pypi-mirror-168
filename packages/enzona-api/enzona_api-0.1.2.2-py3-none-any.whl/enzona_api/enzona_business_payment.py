...
class enzona_business_payment(enzona_api):
    ...
    def create_payments(self, payment):
        ...
        try:
            if response.status_code != 200:
                ...
                return {
                    "success": True,
                    "data": response_payments(response.json())
                }
    ...
    def get_payments(self, merchant_uuid, offset=0, limit=10,
        ...
        response2 = requests.get(
            ...
            "payments?refunds=RTM-0119E30A3E4", headers=headers)
        print(response2)
        try:
            if response.status_code != 200:
                return {
    ...
    def payments_refund(self, transaction_uuid, Payload=None):
        ...
        try:
            response = requests.post(
                "https://api.enzona.net/payment/v1.0.0/payments/" + transaction_uuid + "/refund",
            ...
            if response.status_code != 200:
                ...
                return {
                    "status": False,
                    "error": response_json['fault']['message'],
                    "code": response_json['fault']['code'],
                    "url": response.url,
                    "headers": response.headers,
                }
            else:
    ...
    def get_payment_refund(self, transaction_uuid):
        """
        You get a list of returns made
        :param transaction_uuid: Business Identifier
        :return: Return you get a list of returns made
        """
        headers = {
            'Content-Type': 'application/json',
        ...
        response = requests.get(
            "https://api.enzona.net/payment/v1.0.0/payments/refund/"
            + transaction_uuid, headers=headers)
        try:
            if response.status_code != 200:
                return {
    ...
    #     }
    #     response = requests.get(
    #         "https://api.enzona.net/transfermovil/v1.0.0/"
    #         "payments/refunds/RTM-0119E30A3E41" , headers=headers)
    #     print(response)
    #     try:
    #         if response.status_code != 200:
    #             return {
