...
async def get(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec aws.ec2.vpc_peering_connection.get resource_id="resource_id" name="name"
        ...
        .. code-block:: bash
            ...
            idem exec aws.ec2.vpc_peering_connection.get filters='[{"name": "filter_name", "values": ["filter_value1"]}]'
        ...
        .. code-block:: python
            ...
            async def state_function(hub, ctx, name, resource_id, **kwargs):
                ret = await hub.exec.aws.ec2.vpc_peering_connection.get(ctx, resource_id=resource_id, name=name, **kwargs)
    """
