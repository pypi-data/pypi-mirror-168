...
from spider_bot.config_private import DB_NAME, XPATHS
from spider_bot.models.api import DBAPI
...
class SpiderBot:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.db = DBAPI(DB_NAME, **kwargs)  # pylint: disable=invalid-name
    ...
    def get_user_history_posturls(self, user_url: str, month: int = 1, sleep: int = 10):
        ...
        logger.debug("get_user_history_posturls %s 月, %s", month, user_url)
    ...
    def get_user_new_posturls(self, user_url: str):
    ...
    def get_user_profile(self, user_url: str):
        ...
        logger.debug("profile got: %s %s", user_url, name)
