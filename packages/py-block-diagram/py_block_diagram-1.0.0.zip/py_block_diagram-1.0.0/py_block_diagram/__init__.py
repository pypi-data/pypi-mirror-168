...
class output_block(no_code_python_block,no_box_block):
...
class block_diagram(object):
    ...
    def get_arduino_menu_code(self, indent=None):
        ...
        mylist.extend(menu_param_code)#<-- what about indent here?
        return mylist
...
input_blocks = ['step_input','pulse_input','int_constant_block']
...
class csv_block_diagram_loader(object):
    ...
    def break_into_sections(self):
        section_headers = ['actuators','sensors','blocks','print blocks']
