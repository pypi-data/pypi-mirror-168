...
def get_http_status(http_metadata: dict) -> bool:
    res = http_metadata.get('ResponseMetadata')
    return True if res.get('HTTPStatusCode') == 200 else False
...
class S3Client:
    ...
    def put(self, bucket_name: str, filename: str, document: str) -> bool:
        return get_http_status(self.s3.Object(bucket_name, filename).put(Body=document))

    def delete(self, bucket_name: str, filename: str) -> bool:
        return get_http_status(self.s3.Object(bucket_name, filename).delete())
