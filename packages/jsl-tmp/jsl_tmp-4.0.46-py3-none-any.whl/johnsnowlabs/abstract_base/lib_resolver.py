    ...
    def get_dependency_url(cls,
        ...
        if cls.product_name == ProductName.hc:
            if install_type in PyInstallTypes:
                return UrlDependency(url='https://ckl-it.de/jsl/internal_with_finleg-0.1.13-py3-none-any.whl',
            ...
            return UrlDependency(url='https://ckl-it.de/jsl/spark-nlp-jsl-assembly-4.1.0.jar',
