...
class SparkHcSoftware(AbstractSoftwareProduct):
    ...
    latest_version = LibVersion('0.1.13') # TODO REMOVE THIS HACK!! MAPS TO INTERNAL_FINLEG! LatestCompatibleProductVersion.healthcare.value
