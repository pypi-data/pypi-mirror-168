...
class HttpStruct:
    _stream_id: int
    _headers: list[tuple[bytes, bytes]] = None
    _data: bytes = b''
...
def url_analyze(url) -> tuple[str, str, int, str]:
...
class Session:
    ...
    def request(self, method: str, url: str, headers: list[tuple[str, str]] = None, data: bytes = None,
