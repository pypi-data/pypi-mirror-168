...
class TestDuplicatevoice():
    ...
    def test_case_diff(self, tmp_path: Path):
        ...
        with pytest.raises(hlvox.DuplicateVoice):
            hlvox.Manager(voices_path=voices_dir,
                          databases_path=tmp_path.joinpath("db"))
