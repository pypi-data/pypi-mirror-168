...
class WellHeaderEntity(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, uwi, name, type, fluid, lift_type, version, *args, **kwargs):  # noqa: E501
        """WellHeaderEntity - a model defined in OpenAPI
