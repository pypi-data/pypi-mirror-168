...
class WellHeaderApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.production_get_well_header = Endpoint(
            settings={
                'response_type': (WellHeaderEntity,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/api/production/wellheader/{uwi}',
        ...
        def __production_upsert_well_headers(
            self,
            well_header_input,
            **kwargs
        ):
            ...
            >>> thread = api.production_upsert_well_headers(well_header_input, async_req=True)
            >>> result = thread.get()
        ...
        self.production_upsert_well_headers = Endpoint(
            settings={
                'response_type': ([WellHeaderEntity],),
                'auth': [
                    'bearerAuth'
                ...
                'endpoint_path': '/api/production/wellheaders',
                'operation_id': 'production_upsert_well_headers',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__production_upsert_well_headers
        )
