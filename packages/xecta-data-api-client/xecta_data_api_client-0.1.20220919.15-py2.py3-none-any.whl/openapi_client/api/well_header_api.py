...
class WellHeaderApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __production_add_update_well_headers(
            self,
            well_header_input,
            **kwargs
        ):
            ...
            >>> thread = api.production_add_update_well_headers(well_header_input, async_req=True)
            >>> result = thread.get()
        ...
        self.production_add_update_well_headers = Endpoint(
            settings={
                ...
                'operation_id': 'production_add_update_well_headers',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__production_add_update_well_headers
        )
