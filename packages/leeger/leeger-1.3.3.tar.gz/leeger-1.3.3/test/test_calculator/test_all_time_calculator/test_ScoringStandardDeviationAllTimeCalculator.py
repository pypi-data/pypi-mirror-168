...
class TestScoringStandardDeviationAllTimeCalculator(unittest.TestCase):
    ...
    def test_getScoringStandardDeviation_onlyPostSeasonIsTrue(self):
        ...
        response = ScoringStandardDeviationAllTimeCalculator.getScoringStandardDeviation(league, onlyPostSeason=True)
    ...
    def test_getScoringStandardDeviation_onlyRegularSeasonIsTrue(self):
        ...
        response = ScoringStandardDeviationAllTimeCalculator.getScoringStandardDeviation(league, onlyRegularSeason=True)
    ...
    def test_getScoringStandardDeviation_onlyChampionshipIsTrue(self):
        ...
        response = ScoringStandardDeviationAllTimeCalculator.getScoringStandardDeviation(league, onlyChampionship=True)
    ...
    def test_getScoringStandardDeviation_yearNumberStartGivenWeekNumberStartGiven(self):
        ...
        response = ScoringStandardDeviationAllTimeCalculator.getScoringStandardDeviation(league, yearNumberStart=2001,
                                                                                         weekNumberStart=2)
    ...
    def test_getScoringStandardDeviation_yearNumberEndGivenWeekNumberEndGiven(self):
        ...
        response = ScoringStandardDeviationAllTimeCalculator.getScoringStandardDeviation(league, yearNumberEnd=2001,
                                                                                         weekNumberEnd=2)
