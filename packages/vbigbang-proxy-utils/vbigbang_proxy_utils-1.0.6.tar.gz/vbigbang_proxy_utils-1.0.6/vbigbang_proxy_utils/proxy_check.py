...
class ProxyCheckByZhiMiao(ProxyCheck):
    ...
    zm_ver_referer_list = [
        'https://servicewechat.com/wx2c7f0f3c30d99445/94/page-frame.html',  # 原始版本
    ...
    def _check_ok(self, hosts_list=None) -> (bool, object):
        ...
        try:
            if self.zm_ver_index == 0:
                ...
                response = requests.get(f'https://{hosts}/sc/wx/HandlerSubscribe.ashx', headers=headers,
                ...
                # 贵州版本
                response = requests.get(f'https://{hosts}/sc/api/PovPortal/GetIndex', headers=headers,
