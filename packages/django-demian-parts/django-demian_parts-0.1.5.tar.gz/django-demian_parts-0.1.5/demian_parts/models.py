...
class Type4(models.Model):
    ...
    link_url = models.CharField('link_url', blank=True, help_text="공란 가능", max_length=40)
...
class Type3(models.Model):
    ...
    link_video_url = models.CharField('link_video_url', blank=True, help_text="공란 가능", max_length=40)
