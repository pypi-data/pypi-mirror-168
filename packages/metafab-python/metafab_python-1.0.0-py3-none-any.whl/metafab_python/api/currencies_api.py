...
class CurrenciesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_currency_balances_endpoint = _Endpoint(
            settings={
                'response_type': (float,),
                'auth': [],
                'endpoint_path': '/v1/currencies/{currencyId}/balances',
                'operation_id': 'get_currency_balances',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_currency_balances(
        ...
        **kwargs
        ...
        >>> thread = api.get_currency_balances(currency_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['currency_id'] = \
            currency_id
        return self.get_currency_balances_endpoint.call_with_http_info(**kwargs)
