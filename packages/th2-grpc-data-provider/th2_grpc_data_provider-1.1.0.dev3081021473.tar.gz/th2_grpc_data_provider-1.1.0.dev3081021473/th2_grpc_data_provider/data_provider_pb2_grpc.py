...
class DataProviderStub(object):
    ...
    def __init__(self, channel):
        ...
        self.searchMessageGroups = channel.unary_stream(
                ...
                response_deserializer=th2__grpc__data__provider_dot_data__provider__pb2.MessageGroupsSearchResponse.FromString,
                )
...
def add_DataProviderServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'searchMessageGroups': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=th2__grpc__data__provider_dot_data__provider__pb2.MessageGroupsSearchResponse.SerializeToString,
            ),
...
class DataProvider(object):
    ...
    def searchMessageGroups(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/th2.data_provider.DataProvider/searchMessageGroups',
            ...
            th2__grpc__data__provider_dot_data__provider__pb2.MessageGroupsSearchResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
