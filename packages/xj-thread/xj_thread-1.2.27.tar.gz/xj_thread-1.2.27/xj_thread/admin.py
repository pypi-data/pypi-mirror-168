...
class ThreadCategoryAdmin(admin.ModelAdmin):
    list_display = ('id', 'value', 'need_auth', 'description')
    search_fields = ('id', 'value')
    fields = ('id', 'value', 'description', 'need_auth')
    readonly_fields = ('id',)
...
class ThreadAdmin(admin.ModelAdmin):
    list_display = ('id', 'is_deleted', 'category_id', 'classify_id', 'show', 'user_id', 'auth_id',
    ...
    search_fields = ('id', 'is_deleted', 'category_id', 'classify_id', 'show', 'user_id', 'auth_id',
                     'title', 'content', 'ip', 'has_enroll', 'has_fee', 'has_comment',
                     'cover', 'photos', 'video', 'files', 'logs')
    fields = ('id', 'is_deleted', 'category_id', 'classify_id', 'show', 'user_id', 'auth_id',
              'author', 'title', 'content', 'ip', 'has_enroll', 'has_fee', 'has_comment',
              'cover', 'photos', 'video', 'files', 'price', 'logs', 'more')
...
class ThreadExtendFieldAdmin(admin.ModelAdmin):
    ...
    fields = ('id', "category_id", 'field', 'field_index', 'value', 'type', 'unit', 'config')
    readonly_fields = ('id',)
