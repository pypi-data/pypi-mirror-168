...
class PropertyRemapping:
    ...
    def __init__(self, dynamo_helper: DynamoHelperBase, ignore_custom_stages=True):
        self.dynamo_helper = dynamo_helper
        self.table_helper = TableHelper(dynamo_helper, ignore_custom_stages=ignore_custom_stages)
