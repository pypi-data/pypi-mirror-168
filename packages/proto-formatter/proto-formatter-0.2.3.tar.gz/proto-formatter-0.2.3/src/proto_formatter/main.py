...
def main():
    ...
    format_parser.add_argument(
        ...
        type=bool,
        default=False,
        help="preview formatted protobuf file with syntax highlighting. Default value is False, if it set to True, protobuf files will not be overided by formatted ones."
    )
    format_parser.add_argument(
        "--indents",
        type=int,
