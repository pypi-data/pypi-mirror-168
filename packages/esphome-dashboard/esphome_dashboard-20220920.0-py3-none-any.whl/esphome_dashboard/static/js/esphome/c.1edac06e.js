import{q as t,r as o,b as e,e as s,t as i,n as r,s as n,y as a}from"./index-fad1e0cd.js";import"./c.78fc724b.js";import"./c.5096b8c4.js";import{g as c}from"./c.c2430a4d.js";import{W as l,s as p,a as m}from"./c.2c304877.js";const h=(t,o)=>{import("./c.0b7c7716.js");const e=document.createElement("esphome-logs-dialog");e.configuration=t,e.target=o,document.body.append(e)},d=(t,o,e)=>{import("./c.86138974.js");const s=document.createElement("esphome-logs-webserial-dialog");s.configuration=e,s.port=t,s.closePortOnClose=o,document.body.append(s)};let w=class extends n{constructor(){super(...arguments),this._show="options"}render(){let t,o;return"options"===this._show?(t="How to get the logs for your device?",o=a`
        <mwc-list-item
          twoline
          hasMeta
          dialogAction="close"
