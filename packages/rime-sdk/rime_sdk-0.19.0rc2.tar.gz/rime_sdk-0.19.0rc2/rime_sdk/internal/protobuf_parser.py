...
def parse_test_batch_result(
    ...
    # Hide certain internal-only test batch columns.
    df = df.drop(TEST_BATCH_COLUMNS_TO_HIDE, axis="columns")
...
def parse_test_case_result(raw_result: TestCase, unpack_metrics: bool = False) -> dict:
    ...
    # a safe delete here.
    for key in TEST_CASE_COLUMNS_TO_HIDE:
