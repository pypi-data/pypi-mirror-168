...
class GPUVertBuf:
    ''' Contains a VBO. :param format: Vertex format. :type format: gpu.types.GPUVertFormat :param len: Amount of vertices that will fit into this buffer. :type len: int
    '''
