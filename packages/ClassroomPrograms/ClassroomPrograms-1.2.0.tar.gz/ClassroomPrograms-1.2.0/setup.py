...
setup(
    ...
    description='Tool to support work in the classroom.',
    long_description=read("README.rst"),
    author='Jhonny Osorio Gallego',
    author_email='osoriojohnny1986@gmail.com',
    url='https://github.com/josorio398/Classroom_Programs',
    download_url='https://github.com/josorio398/Classroom_Programs/blob/main/pythonclass.py'.format(
        VERSION),
