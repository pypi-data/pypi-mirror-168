...
class ExperimentalWorkspace(object):
    ...
    def __init__(self, name=None, description=None, project_id=None, cloud_id=None, compute_config_id=None, base_snapshot=None, id=None, created_at=None, creator_id=None, organization_id=None, is_deleted=None, cluster_id=None, environment_id=None, last_used_cloud_id=None, runtime_env_json=None, current_state=None, state=None, is_owner=None, owners=[], local_vars_configuration=None):  # noqa: E501
