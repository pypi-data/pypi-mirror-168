...
def test_verify_cloud(
    ...
    with patch.multiple(
        ...
        verify_aws_subnets=verify_mock,
        ...
        cloud_controller.api_client.get_cloud_with_cloud_resource = Mock(
            return_value=cloud
        )
        ...
        if state in (CloudState.DELETING, CloudState.DELETED):
            ...
            verify_mock.assert_called_with(
                cloud_resource=cloud.result.cloud_resource, logger=cloud_controller.log
            )
