...
class _Taskr:
    ...
    - Map the function name to an object with it's callable, and meta data on it
    ...
    def _populate_settings(self) -> None:
        ...
        # What image to run tasks in
        try:
            self.image_name = getattr_static(self._module, "IMAGE_NAME")
        except AttributeError:
            pass
