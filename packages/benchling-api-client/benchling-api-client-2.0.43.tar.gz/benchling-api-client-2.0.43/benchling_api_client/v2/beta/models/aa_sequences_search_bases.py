...
class AaSequencesSearchBases:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        amino_acids = get_amino_acids() if "aminoAcids" in d else cast(str, UNSET)
        ...
        archive_reason = (
            get_archive_reason()
            if "archiveReason" in d
            else cast(Union[Unset, AaSequencesSearchBasesArchiveReason], UNSET)
        )
        ...
        page_size = get_page_size() if "pageSize" in d else cast(Union[Unset, int], UNSET)
        ...
        sort = get_sort() if "sort" in d else cast(Union[Unset, AaSequencesSearchBasesSort], UNSET)
