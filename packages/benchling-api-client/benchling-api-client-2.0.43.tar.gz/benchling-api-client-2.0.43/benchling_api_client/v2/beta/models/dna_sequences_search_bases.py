...
class DnaSequencesSearchBases:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bases = get_bases() if "bases" in d else cast(str, UNSET)
        ...
        archive_reason = (
            ...
            else cast(Union[Unset, DnaSequencesSearchBasesArchiveReason], UNSET)
        )
        ...
        sort = get_sort() if "sort" in d else cast(Union[Unset, DnaSequencesSearchBasesSort], UNSET)
