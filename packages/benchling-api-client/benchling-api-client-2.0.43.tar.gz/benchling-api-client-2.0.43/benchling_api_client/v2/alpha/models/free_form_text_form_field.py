...
class FreeFormTextFormField:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_canned_responses() -> Union[Unset, FreeFormTextFormFieldCannedResponses]:
            canned_responses: Union[Unset, FreeFormTextFormFieldCannedResponses] = UNSET
        ...
        canned_responses = (
            ...
            if "cannedResponses" in d
            else cast(Union[Unset, FreeFormTextFormFieldCannedResponses], UNSET)
        )
        ...
        default_keyboard = (
            get_default_keyboard()
            if "defaultKeyboard" in d
            else cast(Union[Unset, FreeFormTextFormFieldDefaultKeyboard], UNSET)
        )
        ...
        number_of_lines = get_number_of_lines() if "numberOfLines" in d else cast(Union[Unset, float], UNSET)
        ...
        type = get_type() if "type" in d else cast(Union[Unset, FreeFormTextFormFieldType], UNSET)
