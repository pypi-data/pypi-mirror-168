...
class AnalysisStepDatasetData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        id = get_id() if "id" in d else cast(Union[Unset, None], UNSET)
        ...
        is_multi = get_is_multi() if "isMulti" in d else cast(Union[Unset, None], UNSET)
        ...
        name = get_name() if "name" in d else cast(Union[Unset, None], UNSET)
        ...
        dataset_ids = get_dataset_ids() if "datasetIds" in d else cast(Union[Unset, List[str]], UNSET)
