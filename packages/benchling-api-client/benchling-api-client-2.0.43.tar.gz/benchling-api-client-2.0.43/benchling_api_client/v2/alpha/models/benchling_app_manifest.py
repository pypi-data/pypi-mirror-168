    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_features() -> Union[Unset, List[BenchlingAppManifestFeaturesItem]]:
            ...
            for features_item_data in _features or []:
                features_item = BenchlingAppManifestFeaturesItem.from_dict(features_item_data)
        ...
        features = (
            get_features()
            if "features" in d
            else cast(Union[Unset, List[BenchlingAppManifestFeaturesItem]], UNSET)
        )
        ...
        def get_settings() -> Union[Unset, BenchlingAppManifestSettings]:
            settings: Union[Unset, BenchlingAppManifestSettings] = UNSET
        ...
        settings = (
            get_settings() if "settings" in d else cast(Union[Unset, BenchlingAppManifestSettings], UNSET)
        )
