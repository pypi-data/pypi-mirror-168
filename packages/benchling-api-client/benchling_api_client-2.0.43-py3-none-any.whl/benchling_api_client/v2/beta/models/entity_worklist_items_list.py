...
class EntityWorklistItemsList:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = get_type() if "type" in d else cast(Union[Unset, EntityWorklistItemsListType], UNSET)
        ...
        def get_worklist_items() -> Union[Unset, List[GenericEntity]]:
            ...
            for worklist_items_item_data in _worklist_items or []:
                worklist_items_item = GenericEntity.from_dict(worklist_items_item_data)
        ...
        worklist_items = (
            get_worklist_items() if "worklistItems" in d else cast(Union[Unset, List[GenericEntity]], UNSET)
        )
