...
class WorkflowTask:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        execution_flowchart_id = (
            get_execution_flowchart_id() if "executionFlowchartId" in d else cast(Union[Unset, str], UNSET)
        )
        ...
        def get_responsible_parties() -> Union[Unset, List[PartySummary]]:
            ...
            for responsible_parties_item_data in _responsible_parties or []:
                responsible_parties_item = PartySummary.from_dict(responsible_parties_item_data)
        ...
        responsible_parties = (
            get_responsible_parties()
            if "responsibleParties" in d
            else cast(Union[Unset, List[PartySummary]], UNSET)
        )
