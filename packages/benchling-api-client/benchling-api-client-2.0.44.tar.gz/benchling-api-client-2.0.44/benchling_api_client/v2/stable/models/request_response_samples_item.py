...
class RequestResponseSamplesItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        batch = (
            get_batch() if "batch" in d else cast(Union[Unset, None, RequestResponseSamplesItemBatch], UNSET)
        )
        ...
        entity = (
            get_entity()
            if "entity" in d
            else cast(Union[Unset, None, RequestResponseSamplesItemEntity], UNSET)
        )
