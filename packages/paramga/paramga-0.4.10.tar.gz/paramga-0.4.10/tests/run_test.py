...
class TestRunCls:
    ...
    def test_should_plot_observed_compare(self):
        ...
        runner.store_iterations()
        runner.run()
        print(runner.func(runner.iteration_state.best_parameters, runner.input_data, **self.demo_kwargs()))
    ...
    def test_can_get_initial_output(self):
        ...
        expected_initial_output = self.demo_model()(self.demo_state(), self.demo_data(), **self.demo_kwargs())
    ...
    def test_can_get_best_output(self):
        ...
        expected_best_output = self.demo_model()(self.demo_best_params(), self.demo_data(), **self.demo_kwargs())
