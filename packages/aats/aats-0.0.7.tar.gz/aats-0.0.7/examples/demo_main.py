...
# setup public config
trade_service.set_md_connection(ip='54.199.162.238', port=15007, send_type = NetWorkType.P2P)  # default setting
...
trade_service.set_ts_connection(ip='54.199.162.238', port=8060)  # default setting
