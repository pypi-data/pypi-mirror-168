...
mkt_service.set_control_server(ip='54.199.162.238', port=8060)  # default setting
mkt_service.set_network_cfg(ip='54.199.162.238', port=15004, send_type=NetWorkType.P2P, netcard_name = '')
