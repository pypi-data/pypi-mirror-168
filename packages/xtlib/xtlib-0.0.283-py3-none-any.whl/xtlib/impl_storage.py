...
class ImplStorage(ImplBase):
    ...
    @option(name="hp-set", default="hidden", help="controls how hp_set columns are displayed", values=["hidden", "simple", "changed", "full", "columns", "simple_plus_columns", "user-columns"])
    ...
    def view_tensorboard(self, run_list, experiment, interval, job, browse, workspace, template, direct, detail, snapshot):
        '''
        ...
        pd = {"cwd": cwd, "store_props_dict": spd, "ws_name": workspace, "run_records": run_records, 
            "browse": browse, "interval": interval, "detail": detail, "snapshot": snapshot}
        text = json.dumps(pd)
