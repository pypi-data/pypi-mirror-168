...
from peopledata_did.v1_0.models.data_agreement_model import (
...
from peopledata_did.v1_0.utils.jsonld import ED25519_2018_CONTEXT_URL
from peopledata_did.v1_0.utils.regex import peopledata_DID
from peopledata_did.v1_0.utils.util import current_datetime_in_iso8601
...
class DataAgreementProofSchema(BaseModelSchema):
    ...
    proof_id = fields.Str(
        data_key="id",
        example="did:peopledata:123456789abcdefghi#1",
    ...
    verification_method = fields.Str(
        ...
        example="did:peopledata:123456789abcdefghi",
...
class DataAgreementEventSchema(BaseModelSchema):
    ...
    # Event origin DID
    did = fields.Str(
        data_key="did", description="peopledata decentralised identifier", **peopledata_DID
    )
