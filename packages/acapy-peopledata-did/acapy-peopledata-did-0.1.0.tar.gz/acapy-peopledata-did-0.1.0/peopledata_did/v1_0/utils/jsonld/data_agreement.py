...
from peopledata_did.v1_0.utils.jsonld.create_verify_data import create_verify_data

MULTIBASE_B58_BTC = "z"
MULTICODEC_ED25519_PUB = b"\xed"


def did_peopledata(verkey: str) -> str:
    """Qualify verkey into DID peopledata if need be."""

    if verkey.startswith(f"did:peopledata:{MULTIBASE_B58_BTC}"):
        return verkey

    return f"did:peopledata:{MULTIBASE_B58_BTC}" + bytes_to_b58(
