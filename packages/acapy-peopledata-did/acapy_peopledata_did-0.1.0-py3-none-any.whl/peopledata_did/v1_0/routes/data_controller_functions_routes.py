...
from peopledata_did.v1_0.routes.maps.tag_maps import TAGS_DATA_CONTROLLER_FUNCTIONS_LABEL
from peopledata_did.v1_0.routes.openapi.schemas import UpdateControllerDetailsRequestSchema
...
async def send_data_controller_details_message_handler(request: web.BaseRequest):
    ...
    # Initialise peopledata DID Manager.
