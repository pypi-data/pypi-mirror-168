...
def init(appName: str):
    if(appName == 'chartart'):
        ...
        globals()['webAppBaseUrl'] = 'https://appstratus-28ab2.web.app' #'http://localhost:6060' #
        globals()['apiGatewayBaseUrl'] = 'https://appstratus-gw-42jbwl5b.uc.gateway.dev' #'http://localhost:6061' #
    elif(appName == 'cloudps'):
        globals()['appName'] = appName
        globals()['webAppBaseUrl'] = 'https://appstratus-28ab2.web.app' #'http://localhost:6060' #
        globals()['apiGatewayBaseUrl'] = 'https://appstratus-gw-42jbwl5b.uc.gateway.dev' #'http://localhost:6061' #
