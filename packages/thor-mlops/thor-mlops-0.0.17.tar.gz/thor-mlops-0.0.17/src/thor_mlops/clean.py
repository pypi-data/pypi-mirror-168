...
class NumericalColumn():
    def __init__(self, name: str, impute: str = 'fill', clip: bool = True, v_min: float = None, v_mean: float = None, v_stddev: float = None, v_max: float = None,  mutate_perc: float = 0.0, fill_value: int = -1):
