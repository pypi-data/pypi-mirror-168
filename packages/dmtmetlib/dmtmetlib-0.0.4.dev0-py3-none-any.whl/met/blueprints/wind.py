...
class WindBlueprint(ObservationsBlueprint):
    ...
    def __init__(self, name="Wind", package_path="met", description=""):
        ...
        self.attributes.append(BlueprintAttribute("WindDirection","met/MetVariable","",True))
        self.attributes.append(BlueprintAttribute("WindGust","met/MetVariable","",True))
        self.attributes.append(BlueprintAttribute("WindSpeed","met/MetVariable","",True))