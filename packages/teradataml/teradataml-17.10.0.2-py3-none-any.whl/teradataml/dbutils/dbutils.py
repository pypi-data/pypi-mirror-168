...
def view_log(log_type="script", num_lines=1000):
    ...
    awu_matrix_test.append(("log_type", log_type, True, (str), True,
                            [TableOperatorConstants.SCRIPT_LOG.value, TableOperatorConstants.BYOM_LOG.value]))
    ...
    # Query for viewing last n lines of log.
    view_log_query = eval("TableOperatorConstants.{}_LOG_QUERY".format(log_type.upper())).value\
