    ...
    def __init__(self,
        ...
        PARAMETERS:
            max_rows:
                ...
                Types: int
                Example:
                    teradataml.options.display.max_rows = 20
            ...
            precision:
                ...
                Types: int
                Example:
                    teradataml.options.display.precision = 5

            byte_encoding:
                Specifies the encoding tyyle while displaying BYTE, VARBYTE,
                or BLOB data. User can configure this parameter using display.
                Default Value: base16
                Types: str
                Example:
                    teradataml.options.display.byte_encoding = "ascii"
            ...
            print_sqlmr_query:
                ...
                Types: bool
                Example:
                    teradataml.options.display.print_sqlmr_query = True
            ...
            blob_length:
                ...
                Example:
                    # Set the blob_length.
                    teradataml.options.display.blob_length = 20
        """
        super().__init__()
