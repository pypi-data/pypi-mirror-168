...
def create_context(host = None, username = None, password = None, tdsqlengine = None, temp_database_name = None,
                ...
                * Special characters that may be used in the password are encoded by default.
                  ...
                  Note:
                      When password contains a space:
                        * "encode_password" must be set to False.
    ...
    EXAMPLES:
       ...
       # different initial database by setting the database parameter.
        ...
        # Example 15: Create context when password has special characters and url_encode = False.
        # In this example password "alice@pass" is not encoded and throws an error.
        >>> td_context = create_context(host = 'tdhost', username='alice_pass', password = 'alice@pass',
                                        url_encode=False)

        # Example 16: Create context when password contains space and special characters.
    ...
    # Check if host and username and password are provided
        ...
        # Encode the password if url_encode is True.
        if url_encode:
