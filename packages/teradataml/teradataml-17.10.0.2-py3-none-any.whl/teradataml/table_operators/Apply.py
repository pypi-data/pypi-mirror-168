...
from teradataml.scriptmgmt.lls_utils import get_user_env
...
class Apply(TableOperator):
    ...
    def __init__(self,
        ...
        PARAMETERS:
            ...
            returns:
                ...
                Data argument is required when returns clause is not specified.
                When returns clause is not specified, output column definition should match
        ...
        EXAMPLES:
            ...
            >>> testenv = create_env('testenv', 'python_3.7.9', 'Demo environment');
            ...
            >>> apply_obj.test_script(input_data_file='../barrier.csv')
            ############ STDOUT Output ############
            ...
            >>> apply_obj.install_file(file_name='mapper.py', is_binary=False)
    ...
    def install_file(self, file_name, is_binary=False, replace=False):
        """
        DESCRIPTION:
        ...
        PARAMETERS:
            ...
            is_binary:
                Optional Argument.
                Specifies if the file to be installed or replaced is a binary file.
                Default Value: False
                Types: bool
        ...
        EXAMPLES:
            ...
            >>> apply_obj.install_file(file_name='mapper.py', is_binary=False, replace=True)
            File mapper.py replaced successfully in the remote user environment test_env.

            # Install a binary file.
            >>> apply_obj.install_file(file_name='binary_file.dms', is_binary=True)
            File binary_file.dms installed successfully in the remote user environment test_env.
        """
        ...
        try:
            ...
            # Install file in remote user environment.
            install_file(file_path=file_path, is_binary=is_binary,
                         replace=replace, env_name=self.env_name)
        except:
            raise
    ...
    def remove_file(self, file_name):
        ...
        try:
            remove_file(file_identifier=file_name, env_name=self.env_name)
        except:
            raise
    ...
    def set_data(self,
        ...
        DocString -- TODO
        """
        raise NotImplementedError("To be implemented - BYOA-663")
