...
from teradatasqlalchemy.types import BIGINT, INTEGER, PERIOD_TIMESTAMP, SMALLINT, BYTEINT, FLOAT, DECIMAL
        ...
        try:
            ...
            new_metaexpr = UtilFuncs._get_metaexpr_using_columns(aggregate_node_id,
                                                                 zip(new_column_names,
                                                                     new_column_types))
            agg_df = self._create_dataframe_from_node(aggregate_node_id, new_metaexpr, self._index_label)
