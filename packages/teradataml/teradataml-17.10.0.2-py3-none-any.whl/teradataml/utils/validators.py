...
class _Validators:
    ...
    @staticmethod
    def _validate_argument_is_not_None(arg, arg_name, additional_error=""):
        """
        DESCRIPTION:
            Check whether the arguments provided are not None.
        ...
        if arg is None:
            raise ValueError(Messages.get_message(MessageCodes.ARG_NONE, arg_name, additional_error))
        return True
