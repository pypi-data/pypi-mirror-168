...
@main.command()
@click.option('--item', '-i', type=click.Choice(['logs', 'plugins', 'signed']))
def validate(item):
...
@main.command()
@click.option('--item', '-i', type=click.Choice(['client', 'voucher', 'masters', 'errors', 'faulttrees', 'framework', 'all']), help="Choose the item you want information on from the Registry")
def registry(item):
...
@main.command()
@click.option('--installer', '-i', type=click.Choice(['auc', 'aucclean', 'choco']), help="Choose the installer you want to run")
