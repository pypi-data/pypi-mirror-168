...
from code_util.log import log_error, log, process_status_bar, process_bar_iter
import os
...
class MinioSampleSource(LocalDisk_NLSampleSource):
    ...
    def _download_if_not_exsited(self, name: str):
        ...
        if name in all_sets:
            ...
            for remote_f in process_bar_iter(all_set_files, "download", max=len(all_set_files)):
