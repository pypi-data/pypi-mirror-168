...
class CreatorCoin:
    ...
    def create_coin(self, account_id: str, initial_contract_balance=CONTRACT_INITIAL_BALANCE):
        ...
        res = self.account.lzr_mixer_account.function_call(
            ...
            amount=initial_contract_balance)  # type: ignore
        return res
    ...
    def sell_token(self, account_id: str, amount: int, contract_id: str):
        method = 'ft_burn'
        args = {"account_id": account_id, "sell_amount": str(amount)}

        creator_coin_account = CreatorCoinAccount(contract_id)
        res = creator_coin_account.lzr_mixer_account.function_call(
            contract_id, method, args, amount=1)  # type: ignore
        return res
