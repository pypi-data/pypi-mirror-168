...
LZR_CREATOR_MIXER_SECRET_KEY = os.environ.get('MIXER_SECRET_KEY')
LZR_CREATOR_MIXER_ACCOUNT_ID = os.environ.get(
    'MIXER_ACCOUNT_ID', default='lzr-mixer.testnet')


def get_creator_account_id_from_name(account_name):
    return "%s.%s" % (account_name, LZR_CREATOR_MIXER_ACCOUNT_ID)
