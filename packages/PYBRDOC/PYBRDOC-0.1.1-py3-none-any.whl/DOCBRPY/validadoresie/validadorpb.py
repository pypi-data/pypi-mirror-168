...
class ValidadorPB(object):
	"""
	Realiza a validação de cadeias de caracteres (strings) que representam
	o número da Inscrição Estadual do Estado da Paraíba, conforme regras
	encontradas em http://www.sintegra.gov.br/Cad_Estados/cad_PB.html.
	"""
