...
DATASET_FORMAT_NER = "ner"
DATASET_FORMAT_SPACY = "spacy"
...
class Client():
  ...
  def __init__(self, username:str=None, apikey:str=None, backend:str=None):
    ...
    self.applications = []
    self.supported_dataset_export_formats = [ DATASET_FORMAT_FOLDERS, DATASET_FORMAT_YOLO, DATASET_FORMAT_CSV, DATASET_FORMAT_SPACY ]
    self.supported_dataset_import_formats = [ DATASET_FORMAT_FOLDERS, DATASET_FORMAT_YOLO, DATASET_FORMAT_CSV, DATASET_FORMAT_SPACY ]
