/*! For license information please see 914983c1.js.LICENSE.txt */
"use strict";(self.webpackChunksmartautomatic_server_frontend=self.webpackChunksmartautomatic_server_frontend||[]).push([[878],{89194:(e,t,r)=>{r(48175),r(65660),r(70019);var i=r(9672),n=r(50856);(0,i.k)({_template:n.d`
    <style>
      :host {
    ...
    `}}]}}),i.oi)},73728:(e,t,r)=>{r.d(t,{pV:()=>s,P3:()=>a,Ky:()=>c,D4:()=>d,XO:()=>p,zO:()=>h,oi:()=>f,d4:()=>u,D7:()=>m,ZJ:()=>v,V3:()=>g,WW:()=>w});var i=r(64218),n=r(38346),o=r(5986);const s=32143==r.j?["bluetooth","dhcp","discovery","saserver","homekit","integration_discovery","mqtt","ssdp","unignore","usb","zeroconf"]:null,a=32143==r.j?["reauth"]:null,l={"HA-Frontend-Base":`${location.protocol}//${location.host}`},c=(e,t)=>{var r;return e.callApi("POST","config/config_entries/flow",{handler:t,show_advanced_options:Boolean(null===(r=e.userData)||void 0===r?void 0:r.showAdvanced)},l)},d=(e,t)=>e.callApi("GET",`config/config_entries/flow/${t}`,void 0,l),p=(e,t,r)=>e.callApi("POST",`config/config_entries/flow/${t}`,r,l),h=(e,t,r)=>e.callWS({type:"config_entries/ignore_flow",flow_id:t,title:r}),f=(e,t)=>e.callApi("DELETE",`config/config_entries/flow/${t}`),u=(e,t)=>e.callApi("GET","config/config_entries/flow_handlers"+(t?`?type=${t}`:"")),m=e=>e.sendMessagePromise({type:"config_entries/flow/progress"}),y=(e,t)=>e.subscribeEvents((0,n.D)((()=>m(e).then((e=>t.setState(e,!0)))),500,!0),"config_entry_discovered"),v=e=>(0,i._)(e,"_configFlowProgress",m,y),g=(e,t)=>v(e.connection).subscribe(t),w=(e,t)=>t.context.title_placeholders&&0!==Object.keys(t.context.title_placeholders).length?e(`component.${t.handler}.config.flow_title`,t.context.title_placeholders)||("name"in t.context.title_placeholders?t.context.title_placeholders.name:(0,o.Lh)(e,t.handler)):(0,o.Lh)(e,t.handler)},10754:(e,t,r)=>{r.d(t,{H:()=>i,R:()=>n});const i=e=>e.callWS({type:"supported_brands"}),n=e=>{const t={};for(const[r,i]of Object.entries(e))for(const[e,n]of Object.entries(i))t[e]={name:n,supported_flows:[r]};return t}},2852:(e,t,r)=>{r.d(t,{t:()=>l});var i=r(37500),n=r(73728),o=r(5986),s=r(10754),a=r(52871);const l=(e,t)=>(0,a.w)(e,t,{loadDevicesAndAreas:!0,getFlowHandlers:async e=>{const[t,r,i]=await Promise.all([(0,n.d4)(e,"integration"),(0,n.d4)(e,"helper"),(0,s.H)(e),e.loadBackendTranslation("title",void 0,!0)]);return{integrations:t,helpers:r,supportedBrands:i}},createFlow:async(e,t)=>{const[r]=await Promise.all([(0,n.Ky)(e,t),e.loadBackendTranslation("config",t),e.loadBackendTranslation("title",t)]);return r},fetchFlow:async(e,t)=>{const r=await(0,n.D4)(e,t);return await e.loadBackendTranslation("config",r.handler),r},handleFlowStep:n.XO,deleteFlow:n.oi,renderAbortDescription(e,t){const r=e.localize(`component.${t.handler}.config.abort.${t.reason}`,t.description_placeholders);return r?i.dy`
      ...
      <ha-card outlined>
        ...
        <div class="card-content">
          ...
          ${e.map((e=>{const r=this.hass.states[e.stat_energy_to];return t.dy`
              <div class="row" .source=${e}>
                ...
                <div class="content">
                  <span
                    >${(0,s.Kd)(this.hass,e.stat_energy_from,this.statsMetadata[e.stat_energy_from])}</span
                  >
                  <span
                    >${(0,s.Kd)(this.hass,e.stat_energy_to,this.statsMetadata[e.stat_energy_to])}</span
                  >
                </div>
                <ha-icon-button
        ...
        <div class="card-content">
          ...
          ${this.preferences.device_consumption.map((e=>{const r=this.hass.states[e.stat_consumption];return t.dy`
              <div class="row">
                ...
                <span class="content"
                  >${(0,s.Kd)(this.hass,e.stat_consumption,this.statsMetadata[e.stat_consumption])}</span
                >
                <ha-icon-button
          ...
          ${n.flow_from.map((e=>{const r=this.hass.states[e.stat_energy_from];return t.dy`
              <div class="row" .source=${e}>
                ${null!=r&&r.attributes.icon?t.dy`<ha-icon
                    ...
                    ></ha-svg-icon>`}
                <span class="content"
                  >${(0,a.Kd)(this.hass,e.stat_energy_from,this.statsMetadata[e.stat_energy_from])}</span
                >
                <ha-icon-button
          ...
          ${n.flow_to.map((e=>{const r=this.hass.states[e.stat_energy_to];return t.dy`
              <div class="row" .source=${e}>
                ${null!=r&&r.attributes.icon?t.dy`<ha-icon
                    ...
                    ></ha-svg-icon>`}
                <span class="content"
                  >${(0,a.Kd)(this.hass,e.stat_energy_to,this.statsMetadata[e.stat_energy_to])}</span
                >
                <ha-icon-button
