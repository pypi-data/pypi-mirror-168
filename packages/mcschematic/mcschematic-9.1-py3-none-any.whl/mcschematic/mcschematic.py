...
class BlockDataDB:
    ...
    class BARREL:
        ...
        def fromSS(self, ss: int) -> str:
            return self._barrelSS[ss]
    ...
    class TRAPPED_CHEST:
        ...
        def fromSS(self, ss: int) -> str:
            return self._trapped_chestSS[ss]
    ...
    class BLAST_FURNACE:
        ...
        def fromSS(self, ss: int) -> str:
            return self._blast_furnaceSS[ss]
