...
class SymAPI:
    ...
    def get_current_organization(self) -> dict:
        ...
        TODO(SYM-4119): returns the dictionary of data and not the Organization class
        because the Organization class representation does not match this API
        endpoint's; it can/should change when we are no longer looking up org by email.
        """
        ...
        return self.rest.get("organizations").json()[0]
