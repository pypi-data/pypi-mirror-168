...
telegram_channel_username = global_common.get_environment_variable("TELEGRAM_BOT_USERNAME") if global_common.get_environment() == global_common.Environment.PROD else global_common.get_environment_variable("TELEGRAM_BOT_DEV_USERNAME")
