...
class menu_params_dialog(my_toplevel_window, window_with_param_widgets_that_appear_and_disappear):
    def __init__(self, parent, title="Edit Block Dialog"):
        super().__init__(parent, title=title, geometry="700x300")
    ...
    def make_widgets(self):
        ...
        self.cancel_btn = self.make_button_and_grid("Cancel", bottom_row, mycol, \
