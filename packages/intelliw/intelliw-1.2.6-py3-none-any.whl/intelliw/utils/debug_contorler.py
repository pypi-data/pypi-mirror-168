...
def debug_train():
    ...
    example:
        ...
        iwconfig.INPUT_DATA_SOURCE_TRAIN_TYPE = 1   语料文件类型 1-txt 2-csv 3-json
    '''
    DATASET_ID = None
    ...
    iwconfig.INPUT_DATA_SOURCE_TRAIN_TYPE = 1  # 1-txt 2-csv 3-json
    ...
    try:
        ...
        train_data = get_dataset(
            iwconfig.INPUT_ADDR, iwconfig.INPUT_GETROW_ADDR)
