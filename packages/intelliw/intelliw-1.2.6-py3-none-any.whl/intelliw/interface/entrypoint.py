...
LastEditTime: 2022-09-16 16:39:59
LastEditors: Hexu
...
def __dataset(dataset_id=None, dataset_ratio=[0.7, 0.3, 0], loacl_csv=None, loacl_corpus=None):
    config.set_dataset_config(dataset_id, dataset_ratio, loacl_csv, loacl_corpus)
