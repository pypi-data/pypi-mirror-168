...
@click.argument('archive_bucket')
@click.argument('mrn')
def restore_patient(client_id, restore_date, archive_bucket, mrn, service_account):
...
@click.argument('archive_bucket')
@click.argument('mrn')
def delete_patient_from_archive(client_id, archive_bucket, mrn, service_account):
