...
class VJoinBase(synode.Node):
    ...
    def vjoin(self, output_adaf, input_adafs, output_index, fill,
              minimum_increment, include_rasters, use_reference_time):
        try:
            output_adaf._vjoin(
                input_adafs, output_index=output_index, fill=fill,
...
class VJoinADAF(VJoinBase):
    ...
    def execute(self, node_context):
        ...
        (output_index, minimum_increment, fill, include_rasters,
