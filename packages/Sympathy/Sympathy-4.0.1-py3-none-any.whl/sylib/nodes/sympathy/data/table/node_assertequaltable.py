...
class AssertEqualTable(node.Node):
    ...
    description = (
        'Compare the incoming tables and raise an error if they differ.')
        ...
        for table2 in node_context.input.group('table2'):
            try:
                table1.equal_to(
                    ...
                    inexact_float=inexact_float, rel_tol=rel_tol,
                    abs_tol=abs_tol, raise_exc=True)
