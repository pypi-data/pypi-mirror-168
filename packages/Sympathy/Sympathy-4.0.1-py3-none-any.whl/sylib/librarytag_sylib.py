        ...
        GroupTagType(
            ...
            [GroupTagType(
                ...
                [TagType('Import',
                 ...
                 TagType('Environment',
                         'Input data from environment'),
                 TagType('Generate',
                         'Generate data')],
                desc='Input data, generated, from files, databases or '
                'services'),
             ...
             GroupTagType(
                ...
                [TagType('Export',
                 ...
                 desc='Output data to external files, databases or services'),
             ...
             GroupTagType(
                 ...
                 [TagType('Deprecated',
                  ...
                  TagType('Replaced',
                          ...
                          'different interface'),
                  TagType('Gui',
                          'Node is intended to provide a specific GUI for '
