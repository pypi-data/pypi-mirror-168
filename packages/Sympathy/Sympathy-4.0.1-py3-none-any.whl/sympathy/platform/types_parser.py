...
_lr_productions = [
  ...
  ('start -> definition','start',1,'p_start','types.py',774),
  ('primitive -> TEXT','primitive',1,'p_primitive','types.py',781),
  ('primitive -> TABLE','primitive',1,'p_primitive','types.py',782),
  ('list -> LBRACKET type RBRACKET','list',3,'p_list','types.py',792),
  ('dict -> LBRACE type RBRACE','dict',3,'p_dict','types.py',799),
  ('field -> IDENTIFIER COLON type','field',3,'p_field','types.py',806),
  ('field -> field COMMA IDENTIFIER COLON type','field',5,'p_field','types.py',807),
  ('record -> LPAREN field RPAREN','record',3,'p_record','types.py',820),
  ('tuplefield -> COMMA type','tuplefield',2,'p_tuplefield','types.py',827),
  ('tuplefield -> COMMA type tuplefield','tuplefield',3,'p_tuplefield','types.py',828),
  ('tuple -> LPAREN RPAREN','tuple',2,'p_tuple','types.py',840),
  ('tuple -> LPAREN type tuplefield RPAREN','tuple',4,'p_tuple','types.py',841),
  ('type -> primitive','type',1,'p_type','types.py',853),
  ('type -> list','type',1,'p_type','types.py',854),
  ('type -> dict','type',1,'p_type','types.py',855),
  ('type -> tuple','type',1,'p_type','types.py',856),
  ('type -> record','type',1,'p_type','types.py',857),
  ('type -> definition','type',1,'p_type','types.py',858),
  ('type -> typedefinition','type',1,'p_type','types.py',859),
  ('type -> generic','type',1,'p_type','types.py',860),
  ('type -> function','type',1,'p_type','types.py',861),
  ('type -> LPAREN type RPAREN','type',3,'p_type','types.py',862),
  ('function -> type ARROW type','function',3,'p_function','types.py',872),
  ('typedefinition -> IDENTIFIER','typedefinition',1,'p_typedefinition','types.py',879),
  ('definition -> ALIAS IDENTIFIER EQUALS type','definition',4,'p_definition','types.py',893),
  ('definition -> ALIAS IDENTIFIER EQUALS type EOL','definition',5,'p_definition','types.py',894),
  ('generic -> LABRACKET IDENTIFIER RABRACKET','generic',3,'p_generic','types.py',911),
]
