...
class FigureViewer(ViewerBase):
    ...
    def update_data(self, data):
        if data is not None:
            ...
            # sure that the new figure is resized to fit the size of the
            # canvas.
            ...
            resize_event = QtGui.QResizeEvent(
                self._canvas.size(), self._canvas.size())
            ...
            # Requires re-connection or interactivity is lost, since matplotlib
            # 3.4.
            self._toolbar.connect_canvas()
