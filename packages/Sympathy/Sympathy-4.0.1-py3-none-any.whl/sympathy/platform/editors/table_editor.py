...
class AddColumnDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None, title="New column", default_name='',
                 default_datatype='U'):
        super().__init__(parent)
...
class TableWidget(QtWidgets.QWidget):
    ...
    def __init__(self, data, dynamic_cols=True, parent=None):
        ...
        if dynamic_cols:
            self._add_col_before_action = QtGui.QAction(
                "Add column before", self)
            self._add_col_after_action = QtGui.QAction(
                "Add column after", self)
            self._del_col_action = QtGui.QAction(
                "Delete selected columns", self)
            self._edit_col_action = QtGui.QAction(
                "Edit column name/type", self)
        self._mask_items_action = QtGui.QAction(
