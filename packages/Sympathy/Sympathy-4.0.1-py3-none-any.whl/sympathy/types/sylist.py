...
# change the implementation or possibly, use one single class with multiple
# modes.
...
def is_write_through(sylist_instance):
    return isinstance(sylist_instance, sylistWriteThrough)
