...
class InteractiveTestBase(unittest.TestCase):
    ...
    def setUp(self):
        self.library = sympathy.app.interactive.load_library(
    ...
    def test_library_widgets(self):
        ...
        for nodeid in nodeids:
            try:
                ...
                widget = testnode._SyiNode__configure(return_widget=True)
                qapp.processEvents()
    ...
    def test_library_widgets_modify_parameters(self):
        ...
        for nodeid in nodeids:
            try:
                ...
                qapp.processEvents()
                try:
                    new_parameters = node_context.parameters.to_dict()
                except AttributeError:
