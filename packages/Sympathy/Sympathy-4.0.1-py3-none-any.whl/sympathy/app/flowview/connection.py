...
import functools
from .types import (
    ElementViewInterface, MovableElementViewInterface, get_label,
    HighlightableElementViewInterface, ScaleAnimationHoverHighlighter,
    GraphicsEffectHoverHighlighter)
from .. import themes
...
class ConnectionView(HighlightableElementViewInterface,
    ...
    hover_highlighter_cls = GraphicsEffectHoverHighlighter
    ...
    def _init_actions(self):
        self._delete_action = QtGui.QAction('Delete', self._cvo)
        self._show_info_action = QtGui.QAction('Properties', self._cvo)
    ...
    def _hover_within_bounding_rect(self, event):
        # HACK (Benedikt) to fix not highlighting connections
        return True
