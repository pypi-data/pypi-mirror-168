...
from .. import keymaps
from .. import themes
from sympathy.platform.hooks import status_extra_text
...
class ControlPanel(QtWidgets.QToolBar):
    ...
    def __init__(self, parent):
        super().__init__('Tool bar', parent=parent)
        self._actions = []
        self._separators = []
        ...
        # Not in the toolbar:
        self._save_as_action = QtGui.QAction('Save &As...', self)
        ...
        self._tools_group = QtGui.QActionGroup(self)
        ...
        extra_text = status_extra_text.value()
        if extra_text:
            self.addWidget(QtWidgets.QLabel(extra_text))
