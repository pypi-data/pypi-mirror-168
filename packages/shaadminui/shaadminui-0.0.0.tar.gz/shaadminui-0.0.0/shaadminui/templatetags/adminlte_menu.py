...
from shaadminui.templatetags.adminlte_options import get_adminlte_option, \
    get_adminlte_settings
from shaadminui.models import Menu
    ...
    if not available_apps:
        ...
        if not available_apps:
            try:
                ...
                pass
    if not available_apps:
        logging.warn('shaadminui was unable to retrieve apps list for menu.')
