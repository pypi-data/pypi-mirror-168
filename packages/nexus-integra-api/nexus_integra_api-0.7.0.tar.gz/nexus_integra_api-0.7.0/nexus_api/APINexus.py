...
from nexus_api.exceptions import VoidDataframeException, CorruptDataframeException
...
class APINexus:
    ...
    def filter_installation(self, Datefrom, Dateto, columnas, filter_txt=None, uids=None, resolucion=3, fuente=0) -> pd.DataFrame:
        """
    ...
    def filter_tagview(self, Datefrom, Dateto, columnas, uid_vista, filter_txt=None, uids=None, resolucion=3, fuente=0) -> pd.DataFrame:
        """
        La funcion recibe como parametros la fecha ini, fecha fin, un df con los uid y
