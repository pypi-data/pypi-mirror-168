...
export function flip_side(side) {
    switch (side) {
        case 1 /* Side.Left */: return 2 /* Side.Right */;
        case 2 /* Side.Right */: return 1 /* Side.Left */;
        case 4 /* Side.Bottom */: return 5 /* Side.Top */;
        case 5 /* Side.Top */: return 4 /* Side.Bottom */;
        default: return side;
    }
}
    ...
    _pan_start(ev) {
        ...
        if (xr != null && this.model.x_interaction) {
            if (is_near(ev.sx, left, xscale, tolerance))
                this.side = 1 /* Side.Left */;
            else if (is_near(ev.sx, right, xscale, tolerance))
                this.side = 2 /* Side.Right */;
            else if (is_inside(ev.sx, ev.sy, xscale, yscale, overlay)) {
                this.side = 3 /* Side.LeftRight */;
            }
        }
        if (yr != null && this.model.y_interaction) {
            if (this.side == 0 /* Side.None */ && is_near(ev.sy, bottom, yscale, tolerance))
                this.side = 4 /* Side.Bottom */;
            if (this.side == 0 /* Side.None */ && is_near(ev.sy, top, yscale, tolerance))
                this.side = 5 /* Side.Top */;
            else if (is_inside(ev.sx, ev.sy, xscale, yscale, this.model.overlay)) {
                if (this.side == 3 /* Side.LeftRight */)
                    this.side = 7 /* Side.LeftRightBottomTop */;
                else
                    this.side = 6 /* Side.BottomTop */;
            }
        }
    }
    _pan(ev) {
...
export class RangeTool extends GestureTool {
    constructor(attrs) {
        ...
        this.tool_icon = tool_icon_range;
        this.event_type = "pan";
