...
export declare type ModelSelector<T> = Class<T> | string | {
    type: string;
};
export declare type ChangeCallback = CallbackLike0<Model>;
export declare type EventCallback<T extends ModelEvent = ModelEvent> = CallbackLike0<T>;
export declare type EventCallbackLike<T extends ModelEvent = ModelEvent> = EventCallback<T> | EventCallback<T>["execute"];
