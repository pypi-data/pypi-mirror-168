...
class FactSheetElements:
    ...
    def register_model_entry(self,model_entry_props:'ModelEntryProps'):
        """
        Link Model to Model Entry. Model asset should be stored in either Project or Space and corrsponding ID should be provided when registering to model entry. 
