...
class Spec:
    ...
    def get_inputs(cls) -> []:
        ...
        for key in fields.keys():
            ...
            elif not isinstance(val, InVariable) and not isinstance(val, OutVariable) and not isinstance(val, OptVariable) and key.lower().startswith('in'):
                inputs.append({
                    'key': key,
                    'val': Variable(
    ...
    def get_outputs(cls) -> []:
        ...
        for key in fields.keys():
            ...
            elif not isinstance(val, InVariable) and not isinstance(val, OutVariable) and not isinstance(val, OptVariable) and key.lower().startswith('out'):
                outputs.append({
                    'key': key,
                    'val': Variable(
    ...
    def get_options(cls) -> []:
        ...
        for key in fields.keys():
            ...
            elif not isinstance(val, InVariable) and not isinstance(val, OutVariable) and not isinstance(val, OptVariable) and key.lower().startswith('opt'):
                options.append({
                    'key': key,
                    'val': Variable(
