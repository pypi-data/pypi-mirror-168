...
class _IDatabaseClusterProxy(
    ...
    def grant(
        ...
        *actions: builtins.str,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(IDatabaseCluster.grant)
...
class ParameterGroupFamily(
    ...
    def __init__(self, family: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ParameterGroupFamily.__init__)
            check_type(argname="argument family", value=family, expected_type=type_hints["family"])
...
class DatabaseClusterBase(
    ...
    def grant(
        ...
        *actions: builtins.str,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DatabaseClusterBase.grant)
            check_type(argname="argument grantee", value=grantee, expected_type=type_hints["grantee"])
            check_type(argname="argument actions", value=actions, expected_type=typing.Tuple[type_hints["actions"], ...]) # pyright: ignore [reportGeneralTypeIssues]
        return typing.cast(aws_cdk.aws_iam.Grant, jsii.invoke(self, "grant", [grantee, *actions]))
