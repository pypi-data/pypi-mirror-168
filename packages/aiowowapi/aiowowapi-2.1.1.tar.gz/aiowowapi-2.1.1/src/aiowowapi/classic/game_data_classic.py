...
class GameData:
    ...
    async def get_auction_house_index(self, connected_realm_id: int):
...
See the Connected Realm API for information about retrieving a list of connected realm IDs.
    ...
    async def get_auctions(self, connected_realm_id: int, auction_house_id: int):
...
Depending on the number of active auctions on the specified connected realm, the response from this endpoint may be rather large, sometimes exceeding 10 MB.
    ...
    async def get_pvp_regional_season_index(self, pvp_region_id: int):
    ...
    async def get_pvp_regional_season(self, pvp_region_id: int, pvp_season_id: int):
    ...
    async def get_pvp_leaderboards_index(self, pvp_region_id: int, pvp_season_id: int):
    ...
    async def get_pvp_leaderboard(self, pvp_region_id: int, pvp_season_id: int, pvp_bracket: str):
    ...
    async def get_pvp_rewards_index(self, pvp_region_id: int, pvp_season_id: int):
