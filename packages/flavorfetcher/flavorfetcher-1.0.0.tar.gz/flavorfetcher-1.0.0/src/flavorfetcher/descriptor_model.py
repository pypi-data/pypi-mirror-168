...
class DescriptorExtractorNN:
    ...
    def fit(self, lstm_phrase, lstm_precontext, lstm_postcontext, y,
        ...
        #==========================================
         # Preparing phrase
        lstm_phrase = pad_sequences(lstm_phrase, padding='pre', dtype='float32')
        lstm_phrase = np.reshape(lstm_phrase, (len(lstm_phrase), 1, self.dim))
        
        # Preparing context
        lstm_padded_pre_context = pad_sequences(lstm_precontext, padding='pre', dtype='float32')
        lstm_padded_post_context = pad_sequences(lstm_postcontext, padding='post', dtype='float32')
