...
class CustosOAuthenticator(OAuthenticator):
    ...
    iam_host  = Unicode(os.environ.get("IAM_HOST") or "prod.keycloak.usecustos.org", config=True)
    def __init__(self, **kwargs):
        ...
        tenant_id = x[len(x) - 1]
        self.iam_uri = "https://{}/auth/realms/{}/protocol/openid-connect/".format(self.iam_host, tenant_id)
