...
# Left as a helper
from enoceanx.protocol.constants import RORG  # noqa: F401
...
class EEP(object):
    ...
    def __load_xml(self):
        self.telegrams = {
            enoceanx.utils.from_hex_string(telegram['rorg']): {
                enoceanx.utils.from_hex_string(function['func']): {
                    enoceanx.utils.from_hex_string(type['type'], ): type
