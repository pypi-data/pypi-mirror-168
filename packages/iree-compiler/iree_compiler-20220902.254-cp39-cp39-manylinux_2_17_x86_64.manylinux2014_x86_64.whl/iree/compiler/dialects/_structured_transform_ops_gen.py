...
class MatchOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, target, *, ops=None, interface=None, op_attrs=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class TileToForeachThreadOp(_ods_ir.OpView):
  ...
  def __init__(self, foreach_thread_op, tiled_op, target, num_threads, tile_sizes, *, static_num_threads=None, static_tile_sizes=None, thread_dim_mapping=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class VectorizeOp(_ods_ir.OpView):
  ...
  def __init__(self, transformed, target, *, vectorize_padding=None, loc=None, ip=None):
    ...
    regions = None
    operands.append(_get_op_result_or_value(target))
    if vectorize_padding is not None: attributes["vectorize_padding"] = vectorize_padding
    results.append(transformed)
    _ods_successors = None
    super().__init__(self.build_generic(
      attributes=attributes, results=results, operands=operands,
