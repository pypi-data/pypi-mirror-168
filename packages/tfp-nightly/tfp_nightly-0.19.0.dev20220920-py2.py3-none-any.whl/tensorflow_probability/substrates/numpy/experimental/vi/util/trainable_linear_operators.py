...
from tensorflow_probability.substrates.numpy.bijectors import fill_scale_tril
...
#   `tensorflow_probability/substrates/numpy/experimental/vi/util/trainable_linear_operators.py`
