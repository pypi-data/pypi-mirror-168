...
from tensorflow_probability.substrates.jax.bijectors import fill_scale_tril
...
#   `tensorflow_probability/substrates/jax/experimental/vi/util/trainable_linear_operators.py`
