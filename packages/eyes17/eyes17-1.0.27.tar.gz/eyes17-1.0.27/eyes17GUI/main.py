...
print (pf)	
if 'Windows' in pf:
	from . import diodeIV, editor, filterCircuit, induction, MPU6050, npnCEout, pendulumVelocity, thermocouplelogger
	from . import plotIV, pnpCEout, pt100, RCtransient, RLCsteadystate, RLCtransient, BHCurve, lightsensorlogger
	from . import RLtransient, rodPendulum, scope, soundBeats, soundFreqResp, soundVelocity, drivenpendulum
	from . import sr04dist, utils, logger, XYplot, i2cLogger, tof, advanced_logger, blockcoding
