    ...
    def batch_extract(
        ...
        try:
            ...
            for _batch in sample:
                # extract the images by using the MinioHandler class method
                images: Dict[str, List[np.ndarray]] = self.mh.get_blobs(bucket_name=bucket_name, blob_list=_batch, image_extraction=image_extraction)
                yield images
