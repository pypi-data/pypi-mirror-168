...
import workspaces.UserAccount.models  # noqa: F401  pylint: disable=W0611

alembic_datatable_name = 'alembic_version_useraccount'
...
config.set_main_option(
    'sqlalchemy.url', 'sqlite:///' + os.path.join(top, '..', '..', 'app.db'))
