/*
  ...
  ---------------------------------------------------------------------------  
    ...
    aifes_e_q7_fnn_inference((float*)input_data,(float*)output_data);
  ---------------------------------------------------------------------------
...
#ifndef AIFES_E_Q7_FNN
#define AIFES_E_Q7_FNN

#define DATASETS 1
#define FNN_LAYERS PLACEHOLDER_LAYERS

void aifes_e_q7_fnn_inference(float* input_data, float* output_data)
{
  ...
  FNN.flat_weights = (void*) model_parameters;
