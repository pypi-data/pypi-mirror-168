/*
  ...
  Add this file to your IDE with the aifes_e_f32_fnn.h file
...
*/
#ifndef AIFES_E_F32_WEIGHTS
#define AIFES_E_F32_WEIGHTS


const float aifes_e_f32_flat_weights[] = {PLACEHOLDER_WEIGHTS};
