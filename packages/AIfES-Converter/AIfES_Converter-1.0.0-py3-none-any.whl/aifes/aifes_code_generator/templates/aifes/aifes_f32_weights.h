/*
  ...
  Add this file to your IDE with the aifes_f32_fnn.h file
...
#ifndef AIFES_F32_WEIGHTS
#define AIFES_F32_WEIGHTS


const float aifes_f32_flat_weights[] = {PLACEHOLDER_WEIGHTS};
