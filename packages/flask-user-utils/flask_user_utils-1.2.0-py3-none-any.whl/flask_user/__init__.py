...
from .views import (LoginView, LogoutView, MakeLoginView,
                    MakeSuperUserLoginView, RegisterView, RegistrationView,
                    SuperUserLoginView)
...
class FlaskUser:
    ...
    def add_superuser_login(self, success_endpoint: str) -> None:
        self.bp.add_url_rule('/superuser-login',
                             view_func=SuperUserLoginView.as_view('superuser_login'))
        MakeSuperUserLoginView.success_endpoint = success_endpoint
        self.bp.add_url_rule('/make-superuser-login',
                             view_func=MakeSuperUserLoginView.as_view('make_superuser_login'))
