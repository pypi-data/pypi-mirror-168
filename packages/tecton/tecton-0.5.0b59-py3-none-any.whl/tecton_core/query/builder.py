...
def build_spine_join_querytree(
    ...
    if fdw.is_temporal or fdw.is_feature_table:
        ...
        ret = RenameColsNode(ttl_node, rename_map).as_ref()
    elif fdw.is_temporal_aggregate:
        data_delay_seconds = 0 if fdw.is_stream else fdw.allowed_upstream_lateness.in_seconds()
