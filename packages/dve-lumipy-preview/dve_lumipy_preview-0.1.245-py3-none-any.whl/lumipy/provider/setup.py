...
def setup(certs_path=None, version='1.11.25', verbosity='m') -> None:
...
def copy_certs(certs_path, version='1.11.25'):

    print(f"  • copying certs from {certs_path}")
