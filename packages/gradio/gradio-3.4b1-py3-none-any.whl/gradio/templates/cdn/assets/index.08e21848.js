...
import { M as ModifyUpload } from './ModifyUpload.cdf34336.js';
...
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*pending*/ 256) audio_changes.pending = /*pending*/ ctx[8];
			if (dirty & /*streaming*/ 512) audio_changes.streaming = /*streaming*/ ctx[9];
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, label, show_label, _value, name, source, pending, streaming, $_, value, dragging, mode, loading_status*/ 16793593) {
