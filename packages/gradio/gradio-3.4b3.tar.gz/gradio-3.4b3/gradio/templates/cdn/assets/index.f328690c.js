		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen(textarea, "keypress", /*handle_keypress*/ ctx[9])
				];
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, style, label, show_label, lines, max_lines, mode, placeholder, value, loading_status*/ 18419) {
