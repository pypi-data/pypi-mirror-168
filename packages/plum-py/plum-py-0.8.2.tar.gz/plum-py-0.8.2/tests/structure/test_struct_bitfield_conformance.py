...
class TestFirst(Case):
    ...
    data = CaseData(
        ...
        implementation=Baseline(
            """
            def __init__(self, *, m1: 'Pet', m2: int = m2.default, m3: int = m3.default, m4: int = m4.default) -> None:
                if not 0 <= m1 <= 15:
...
class TestLast(Case):
    ...
    data = CaseData(
        ...
        implementation=Baseline(
            """
            def __init__(self, *, m0: int = m0.default, m1: int, m2: int = m2.default, m3: int = m3.default) -> None:
                if not 0 <= m1 <= 15:
                   raise ValueError("'m1' out of range, 0 <= m1 <= 15")
