...
from jaaql.constants import ENCODING__utf, KEY__tenant
...
def create_interface(config, address: str, port: int, database: str, username: str, password: str = None, role: str = None):
    ...
    instance = interface_class(config, address, port, database, username, role=role, password=password)
