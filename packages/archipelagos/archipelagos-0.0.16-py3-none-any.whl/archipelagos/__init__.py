    ...
    def get_time_series(source: str,
        ...
        if isinstance(returns, str):
            ...
            if return_pandas or return_numpy:
                ...
                request = TimeSeriesRequest(source, category, label, start, end, features, max_size, ascending, api_key)
    ...
    def get_collection(source: str,
        ...
        if isinstance(returns, str):
            ...
            if return_pandas or return_numpy:
                ...
                request = CollectionRequest(source, category, label, features, max_size, api_key)
                response = Archipelagos.send(request)
