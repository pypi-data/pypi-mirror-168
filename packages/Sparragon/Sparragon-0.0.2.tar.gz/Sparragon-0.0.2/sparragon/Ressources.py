...
class Resources:
    ...
    def set_gold_from_sceen(self: Resources, bbox: tuple[int, int, int, int]) -> None:
    ...
    def set_minerals_from_screen(self: Resources, bbox: tuple[int, int, int, int]) -> None:
    ...
    def set_chips_from_screen(self: Resources, bbox: tuple[int, int, int, int]) -> None: ...

    def set_resources_from_screen(self: Resources) -> None:
        """Obtains and stores the amount of minerals and gold from the top of your screen
        """
        self.set_gold_from_sceen((940, 110, 1020, 130))
        self.set_minerals_from_screen((1100, 110, 1175, 130))