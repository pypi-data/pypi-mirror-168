...
# TODO: toggle this based on version?
def value_polyfil(dset):
    return dset[()]
...
class Dataset:
    ...
    def load(self, path):
        ...
        self.meta_data = eval(value_polyfil(self.dfile["meta"]))
    ...
    def get_all_bits(self):
        ...
        """
        return value_polyfil(self.dfile["data"])[:, -1]
    ...
    def get_all_events(self):
        ...
        """
        return value_polyfil(self.dfile["data"])
    ...
    def get_analog_meta(self):
        ...
        if "analog_meta" in self.dfile.keys():
            return eval(value_polyfil(self.dfile["analog_meta"]))
        else:
            raise KeyError("No analog data was saved.")
    ...
    def duty_cycle(self, line):
        ...
        """
        # this is broken but other code might be dependent on it working this way...
        return "fix me"
        bit = self._line_to_bit(line)  # type: ignore[unreachable]
    ...
    def plot_all(
        ...
        for bit in range(32):
            if len(self.get_events_by_bit(bit)) > 0:
                # this is broken but other code might be dependent on it working this way...
                self.plot_bit(  # type: ignore[attr-defined]
                    bit,
                    start_time,
                    stop_time,
                    auto_show=False,
