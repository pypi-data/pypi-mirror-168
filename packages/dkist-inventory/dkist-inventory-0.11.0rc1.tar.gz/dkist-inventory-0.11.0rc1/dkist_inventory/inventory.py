...
def _inventory_from_headers(headers: Table):
    ...
    unique_optional_key_map = {
        "IDSPARID": "inputDatasetParametersPartId",
        "IDSOBSID": "inputDatasetObserveFramesPartId",
        "IDSCALID": "inputDatasetCalibrationFramesPartId",
        "OBSPR_ID": "observingProgramExecutionId",
        "IP_ID": "instrumentProgramExecutionId",
    }
    for fits_key, inventory_key in unique_optional_key_map.items():
