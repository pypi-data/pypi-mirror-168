...
_ADDTOKENREQUEST = DESCRIPTOR.message_types_by_name['AddTokenRequest']
_ADDTOKENRESPONSE = DESCRIPTOR.message_types_by_name['AddTokenResponse']
AddTokenRequest = _reflection.GeneratedProtocolMessageType('AddTokenRequest', (_message.Message,), {
  'DESCRIPTOR' : _ADDTOKENREQUEST,
  '__module__' : 'token_pb2'
  # @@protoc_insertion_point(class_scope:batchx.token.AddTokenRequest)
  })
_sym_db.RegisterMessage(AddTokenRequest)

AddTokenResponse = _reflection.GeneratedProtocolMessageType('AddTokenResponse', (_message.Message,), {
  'DESCRIPTOR' : _ADDTOKENRESPONSE,
  '__module__' : 'token_pb2'
  # @@protoc_insertion_point(class_scope:batchx.token.AddTokenResponse)
  })
_sym_db.RegisterMessage(AddTokenResponse)
