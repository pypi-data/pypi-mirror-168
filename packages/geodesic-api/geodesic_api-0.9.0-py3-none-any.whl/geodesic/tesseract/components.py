...
from geodesic.descriptors import BoolDescr, DTypeDescr, DatetimeIntervalDescr, DictDescr, FloatDescr, IntDescr, \
    ListDescr, NumberDescr, RegexDescr, StringDescr, TupleDescr, TypeConstrainedDescr, BaseDescr, \
    URLDescr
