...
_ASSETDATAINFO = DESCRIPTOR.message_types_by_name['AssetDataInfo']
...
AssetDataInfo = _reflection.GeneratedProtocolMessageType('AssetDataInfo', (_message.Message,), {
  'DESCRIPTOR' : _ASSETDATAINFO,
  '__module__' : 'inference_pb2'
  # @@protoc_insertion_point(class_scope:workerv1.AssetDataInfo)
  })
_sym_db.RegisterMessage(AssetDataInfo)

ModelInfo = _reflection.GeneratedProtocolMessageType('ModelInfo', (_message.Message,), {
  'DESCRIPTOR' : _MODELINFO,
  '__module__' : 'inference_pb2'
  # @@protoc_insertion_point(class_scope:workerv1.ModelInfo)
  })
