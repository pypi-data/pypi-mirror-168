...
"""
    ...
    def determine_runtime_environment_based_on_environment_variables(
        ...
        if github_ev and azure_ev:
            raise ValueError(
                "It seems like both the GitHub- and Azure-specific environment variables are non-empty. This shouldn't be possible and implies shrike should be using alternate environment variables to determine the runtime environment. Please open an issue in the GitHub shrike repository: https://github.com/Azure/shrike/issues."
            )
        elif github_ev:
