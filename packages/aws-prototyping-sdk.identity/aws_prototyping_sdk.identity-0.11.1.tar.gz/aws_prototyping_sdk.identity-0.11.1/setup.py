    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-cognito-identitypool-alpha==2.42.0.a0",
        "aws_prototyping_sdk.pdk_nag>=0.11.0, <0.12.0",
        "cdk-nag>=2.18.14, <3.0.0",
        "constructs>=10.1.106, <11.0.0",
        "jsii>=1.67.0, <2.0.0",
        "projen>=0.62.10, <0.63.0",
        "publication>=0.0.3",
        "typeguard~=2.13.3"
    ],
    "classifiers": [
