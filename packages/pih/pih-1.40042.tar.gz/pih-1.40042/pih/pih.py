...
class PIH:
    ...
    class RESULT:
        ...
        class INVENTORY:
            ...
            @staticmethod
            def inventory_report_information(report_file_path: str) -> Result[List[InventoryReportInformation]]:
                return DataTools.to_result(
                    RPC_COMMANDS.DOCS.inventory_report_information(report_file_path), InventoryReportInformation)
