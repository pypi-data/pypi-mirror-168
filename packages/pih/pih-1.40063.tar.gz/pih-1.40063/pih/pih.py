    ...
    class MESSAGE:
        ...
        class COMMAND:
            ...
            def service_started(role: ServiceRoles) -> bool:
                role_value: ServiceRoleValue = role.value
                return PIH.log_command(LogCommands.SERVICE_STARTED, (role.name, role_value.description, role_value.host, role_value.port))
