...
class RPC_COMMANDS:
    ...
    class DOCS:
        ...
        @staticmethod
        def inventory_report_information(report_file_path: str) -> str:
            return RPC.call(RPC_COMMANDS.DOCS.create_rpc_command("inventory_report_information"), (report_file_path))
