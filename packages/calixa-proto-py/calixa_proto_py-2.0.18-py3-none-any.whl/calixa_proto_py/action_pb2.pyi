...
class LeadCreateParams(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"company_name",b"company_name",u"email",b"email",u"first_name",b"first_name",u"last_name",b"last_name",u"owner_id",b"owner_id"]) -> None: ...
