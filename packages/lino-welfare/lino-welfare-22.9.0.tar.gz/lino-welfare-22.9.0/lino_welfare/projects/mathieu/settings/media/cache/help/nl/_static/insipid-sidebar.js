$(document).ready(function () {
    ...
    function updateSidebarAttributesVisible() {
        $sidebar_button.attr('title', "Zijpaneel inklappen");
        $sidebar_button.attr('aria-label', "Zijpaneel inklappen");
    ...
    function updateSidebarAttributesHidden() {
        $sidebar_button.attr('title', "Zijpaneel uitklappen");
        $sidebar_button.attr('aria-label', "Zijpaneel uitklappen");
