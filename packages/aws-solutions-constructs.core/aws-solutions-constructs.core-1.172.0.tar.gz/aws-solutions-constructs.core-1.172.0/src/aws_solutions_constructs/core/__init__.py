...
class AddProxyMethodToApiResourceInputParams:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(AddProxyMethodToApiResourceInputParams.__init__)
...
class BuildDeadLetterQueueProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(BuildDeadLetterQueueProps.__init__)
...
class BuildDynamoDBTableProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(BuildDynamoDBTableProps.__init__)
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(dynamo_table_props, dict):
            dynamo_table_props = aws_cdk.aws_dynamodb.TableProps(**dynamo_table_props)
        if __debug__:
            type_hints = typing.get_type_hints(BuildDynamoDBTableWithStreamProps.__init__)
            check_type(argname="argument dynamo_table_props", value=dynamo_table_props, expected_type=type_hints["dynamo_table_props"])
            check_type(argname="argument existing_table_interface", value=existing_table_interface, expected_type=type_hints["existing_table_interface"])
        self._values: typing.Dict[str, typing.Any] = {}
        if dynamo_table_props is not None:
...
class BuildElasticSearchProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(BuildElasticSearchProps.__init__)
...
class BuildEventBusProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(BuildEventBusProps.__init__)
...
class BuildGlueJobProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(BuildGlueJobProps.__init__)
...
class BuildKinesisAnalyticsAppProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BuildKinesisAnalyticsAppProps.__init__)
...
class BuildKinesisStreamProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(BuildKinesisStreamProps.__init__)
...
class BuildLambdaFunctionProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(BuildLambdaFunctionProps.__init__)
...
class BuildQueueProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(BuildQueueProps.__init__)
...
class BuildS3BucketProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(BuildS3BucketProps.__init__)
...
class BuildSagemakerEndpointProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(BuildSagemakerEndpointProps.__init__)
...
class BuildSagemakerNotebookProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(BuildSagemakerNotebookProps.__init__)
...
class BuildTopicProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(BuildTopicProps.__init__)
            check_type(argname="argument enable_encryption_with_customer_managed_key", value=enable_encryption_with_customer_managed_key, expected_type=type_hints["enable_encryption_with_customer_managed_key"])
            check_type(argname="argument encryption_key", value=encryption_key, expected_type=type_hints["encryption_key"])
            check_type(argname="argument encryption_key_props", value=encryption_key_props, expected_type=type_hints["encryption_key_props"])
...
class BuildVpcProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(BuildVpcProps.__init__)
...
class BuildWebaclProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(BuildWebaclProps.__init__)
...
class CfnNagSuppressRule:
    def __init__(self, *, id: builtins.str, reason: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CfnNagSuppressRule.__init__)
...
class EventSourceProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(EventSourceProps.__init__)
...
class ObtainMemcachedClusterProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ObtainMemcachedClusterProps.__init__)
...
class SecurityGroupRuleDefinition:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SecurityGroupRuleDefinition.__init__)
...
class SinkDataStoreProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(SinkDataStoreProps.__init__)
...
class VerifiedProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(VerifiedProps.__init__)
