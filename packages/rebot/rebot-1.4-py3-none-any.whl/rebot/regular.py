...
logger = logging.getLogger('ReBot')
...
class Update(JsonDeserializable):
    ...
    :type poll_answer: :class:`ReBot.types.PollAnswer`
    ...
    :type my_chat_member: :class:`ReBot.types.ChatMemberUpdated`
    ...
    :type chat_member: :class:`ReBot.types.ChatMemberUpdated`
    ...
    :type chat_join_request: :class:`ReBot.types.ChatJoinRequest`

    :return: Instance of the class
    :rtype: :class:`ReBot.types.Update`
...
class ChatJoinRequest(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ChatJoinRequest`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class WebhookInfo(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.WebhookInfo`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class Chat(JsonDeserializable):
    ...
    :type photo: :class:`ReBot.types.ChatPhoto`
    ...
    :param location: Optional. For supergroups, the location to which the supergroup is connected. Returned only in 
        getChat.
    :type location: :class:`ReBot.types.ChatLocation`

    :return: Instance of the class
    :rtype: :class:`ReBot.types.Chat`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class MessageID(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.MessageId`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class WebAppData(JsonDeserializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.WebAppData`
    """
...
class Message(JsonDeserializable):
    ...
    :type sender_chat: :class:`ReBot.types.Chat`
    ...
    :type reply_to_message: :class:`ReBot.types.Message`

    :param via_bot: Optional. Bot through which the message was sent
    :type via_bot: :class:`ReBot.types.User`
    ...
    :param entities: Optional. For text messages, special entities like usernames, URLs, bot commands, etc. that 
        appear in the text
    :type entities: :obj:`list` of :class:`ReBot.types.MessageEntity`

    :param animation: Optional. Message is an animation, information about the animation. For backward 
        compatibility, when this field is set, the document field will also be set
    :type animation: :class:`ReBot.types.Animation`

    :param audio: Optional. Message is an audio file, information about the file
    :type audio: :class:`ReBot.types.Audio`

    :param document: Optional. Message is a general file, information about the file
    :type document: :class:`ReBot.types.Document`

    :param photo: Optional. Message is a photo, available sizes of the photo
    :type photo: :obj:`list` of :class:`ReBot.types.PhotoSize`

    :param sticker: Optional. Message is a sticker, information about the sticker
    :type sticker: :class:`ReBot.types.Sticker`

    :param video: Optional. Message is a video, information about the video
    :type video: :class:`ReBot.types.Video`

    :param video_note: Optional. Message is a video note, information about the video message
    :type video_note: :class:`ReBot.types.VideoNote`

    :param voice: Optional. Message is a voice message, information about the file
    :type voice: :class:`ReBot.types.Voice`
    ...
    :type caption_entities: :obj:`list` of :class:`ReBot.types.MessageEntity`

    :param contact: Optional. Message is a shared contact, information about the contact
    :type contact: :class:`ReBot.types.Contact`

    :param dice: Optional. Message is a dice with random value
    :type dice: :class:`ReBot.types.Dice`

    :param game: Optional. Message is a game, information about the game. More about games »
    :type game: :class:`ReBot.types.Game`
    ...
    :type venue: :class:`ReBot.types.Venue`

    :param location: Optional. Message is a shared location, information about the location
    :type location: :class:`ReBot.types.Location`
    ...
    :type new_chat_photo: :obj:`list` of :class:`ReBot.types.PhotoSize`
    ...
    :param message_auto_delete_timer_changed: Optional. Service message: auto-delete timer settings changed in 
        the chat
    :type message_auto_delete_timer_changed: :class:`ReBot.types.MessageAutoDeleteTimerChanged`
    ...
    :type invoice: :class:`ReBot.types.Invoice`
    ...
    :type successful_payment: :class:`ReBot.types.SuccessfulPayment`
    ...
    :type reply_markup: :class:`ReBot.types.InlineMarkup`

    :return: Instance of the class
    :rtype: :class:`ReBot.types.Message`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
        ...
        if 'reply_markup' in obj:
            opts['reply_markup'] = InlineMarkup.de_json(obj['reply_markup'])
    ...
    def __init__(self, message_id, from_user, date, chat, content_type, options, json_string):
        ...
        self.reply_markup: Optional[InlineMarkup] = None
        for key in options:
...
class MessageEntity(Dictionaryable, JsonSerializable, JsonDeserializable):
    ...
    :type user: :class:`ReBot.types.User`
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.MessageEntity`
    """
    @staticmethod
...
class PhotoSize(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.PhotoSize`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class Audio(JsonDeserializable):
    ...
    :type thumb: :class:`ReBot.types.PhotoSize`

    :return: Instance of the class
    :rtype: :class:`ReBot.types.Audio`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class Document(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.Document`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class VideoNote(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.VideoNote`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class Contact(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.Contact`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class Location(JsonDeserializable, JsonSerializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.Location`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class UserProfilePhotos(JsonDeserializable):
    ...
    :type photos: :obj:`list` of :obj:`list` of :class:`ReBot.types.PhotoSize`

    :return: Instance of the class
    :rtype: :class:`ReBot.types.UserProfilePhotos`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class ForceReply(JsonSerializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ForceReply`
    """
...
class ReplyKeyboardRemove(JsonSerializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ReplyKeyboardRemove`
    """
...
class WebAppInfo(JsonDeserializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.WebAppInfo`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class ReplyKeyboardMarkup(JsonSerializable):
    ...
    .. code-block:: python3
        ...
        from ReBot.types import ReplyKeyboardMarkup, KeyboardButton
    ...
    :param keyboard: :obj:`list` of button rows, each represented by an :obj:`list` of 
        :class:`ReBot.types.KeyboardButton` objects
    :type keyboard: :obj:`list` of :obj:`list` of :class:`ReBot.types.KeyboardButton`
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ReplyKeyboardMarkup`
    """
    max_row_keys = 12
    ...
    def add(self, *args, row_width=None):
        ...
        :type args: :obj:`str` or :class:`ReBot.types.KeyboardButton`
...
class KeyboardButtonPollType(Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.KeyboardButtonPollType`
    """
...
class KeyboardButton(Dictionaryable, JsonSerializable):
    ...
    :type request_poll: :class:`ReBot.types.KeyboardButtonPollType`
    ...
    :type web_app: :class:`ReBot.types.WebAppInfo`

    :return: Instance of the class
    :rtype: :class:`ReBot.types.KeyboardButton`
    """
...
class InlineMarkup(Dictionaryable, JsonSerializable, JsonDeserializable):
    """
    This object represents an inline keyboard that appears right next to the message it belongs to.

    .. note::
        It is recommended to use :meth:`ReBot.util.quick_markup` instead.

    .. code-block:: python3
        :caption: Example of a custom keyboard with buttons.

        from ReBot.util import quick_markup
    ...
    Telegram Documentation: https://core.telegram.org/bots/api#InlineMarkup

    :param inline_keyboard: :obj:`list` of button rows, each represented by an :obj:`list` of 
        :class:`ReBot.types.InlineBtn` objects
    :type inline_keyboard: :obj:`list` of :obj:`list` of :class:`ReBot.types.InlineBtn`

    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineMarkup`
    """
    max_row_keys = 8
    ...
    def de_json(cls, json_string):
        if json_string is None: return None
        obj = cls.check_json(json_string, dict_copy=False)
        keyboard = [[InlineBtn.de_json(button) for button in row] for row in obj['inline_keyboard']]
    ...
    def __init__(self, keyboard=None, row_width=3):
        ...
        self.row_width: int = row_width
        self.keyboard: List[List[InlineBtn]] = keyboard or []

    def add(self, *args, row_width=None):
        """
        This method adds buttons to the keyboard without exceeding row_width.

        E.g. InlineMarkup.add("A", "B", "C") yields the json result:
        {keyboard: [["A"], ["B"], ["C"]]}
        when row_width is set to 1.
        When row_width is set to 2, the result:
        {keyboard: [["A", "B"], ["C"]]}
        See https://core.telegram.org/bots/api#InlineMarkup
        
        :param args: Array of InlineBtn to append to the keyboard
        :type args: :obj:`list` of :class:`ReBot.types.InlineBtn`
    ...
    def row(self, *args):
        """
        Adds a list of InlineBtn to the keyboard.
        This method does not consider row_width.

        InlineMarkup.row("A").row("B", "C").to_json() outputs:
        '{keyboard: [["A"], ["B", "C"]]}'
        See https://core.telegram.org/bots/api#InlineMarkup
...
class InlineBtn(Dictionaryable, JsonSerializable, JsonDeserializable):
    """
    This object represents one button of an inline keyboard. You must use exactly one of the optional fields.

    Telegram Documentation: https://core.telegram.org/bots/api#InlineBtn
    ...
    :type login_url: :class:`ReBot.types.LoginUrl`
    ...
    :type callback_game: :class:`ReBot.types.CallbackGame`
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineBtn`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class LoginUrl(Dictionaryable, JsonSerializable, JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.LoginUrl`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class CallbackQuery(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.CallbackQuery`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class ChatPhoto(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ChatPhoto`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class ChatMember(JsonDeserializable):
    ...
    * :class:`ReBot.types.ChatMemberOwner`
    * :class:`ReBot.types.ChatMemberAdministrator`
    * :class:`ReBot.types.ChatMemberMember`
    * :class:`ReBot.types.ChatMemberRestricted`
    * :class:`ReBot.types.ChatMemberLeft`
    * :class:`ReBot.types.ChatMemberBanned`
...
class ChatMemberOwner(ChatMember):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ChatMemberOwner`
    """
    pass
...
class ChatMemberAdministrator(ChatMember):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ChatMemberAdministrator`
    """
    pass
...
class ChatMemberMember(ChatMember):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ChatMemberMember`
    """
    pass
...
class ChatMemberRestricted(ChatMember):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ChatMemberRestricted`
    """
    pass
...
class ChatMemberLeft(ChatMember):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ChatMemberLeft`
    """
    pass
...
class ChatMemberBanned(ChatMember):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ChatMemberBanned`
    """
    pass
...
class ChatPermissions(JsonDeserializable, JsonSerializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ChatPermissions`
    """
    @classmethod
    def de_json(cls, json_string):
...
class BotCommand(JsonSerializable, JsonDeserializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.BotCommand`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class BotCommandScope(ABC, JsonSerializable):
    ...
    * :class:`BotCommandScopeDefault`
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.BotCommandScope`
    """
...
class BotCommandScopeDefault(BotCommandScope):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.BotCommandScopeDefault`
    """
    def __init__(self):
        """
...
class BotCommandScopeAllPrivateChats(BotCommandScope):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.BotCommandScopeAllPrivateChats`
    """
    def __init__(self):
        """
        Represents the scope of bot commands, covering all private chats.
...
class BotCommandScopeAllGroupChats(BotCommandScope):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.BotCommandScopeAllGroupChats`
    """
    def __init__(self):
        """
        Represents the scope of bot commands, covering all group and supergroup chats.
...
class BotCommandScopeAllChatAdministrators(BotCommandScope):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.BotCommandScopeAllChatAdministrators`
    """
    def __init__(self):
        """
        Represents the scope of bot commands, covering all group and supergroup chat administrators.
...
class BotCommandScopeChat(BotCommandScope):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.BotCommandScopeChat`
    """
...
class BotCommandScopeChatAdministrators(BotCommandScope):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.BotCommandScopeChatAdministrators`
    """
    def __init__(self, chat_id=None):
...
class BotCommandScopeChatMember(BotCommandScope):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.BotCommandScopeChatMember`
    """
...
class InlineQuery(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQuery`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class InputTextMessageContent(Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InputTextMessageContent`
    """
...
class InputLocationMessageContent(Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InputLocationMessageContent`
    """
...
class InputVenueMessageContent(Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InputVenueMessageContent`
    """
...
class InputContactMessageContent(Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InputContactMessageContent`
    """
...
class InputInvoiceMessageContent(Dictionaryable):
    ...
    :type prices: :obj:`list` of :class:`ReBot.types.LabeledPrice`
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InputInvoiceMessageContent`
    """
...
class ChosenInlineResult(JsonDeserializable):
    ...
    :type from: :class:`ReBot.types.User`
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ChosenInlineResult`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class SentWebAppMessage(JsonDeserializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.SentWebAppMessage`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class InlineQueryResultArticle(InlineQueryResultBase):
    ...
    :type input_message_content: :class:`ReBot.types.InputMessageContent`
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultArticle`
    """
...
class InlineQueryResultPhoto(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultPhoto`
    """
...
class InlineQueryResultGif(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultGif`
    """
...
class InlineQueryResultMpeg4Gif(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultMpeg4Gif`
    """
...
class InlineQueryResultVideo(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultVideo`
    """
...
class InlineQueryResultAudio(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultAudio`
    """
...
class InlineQueryResultVoice(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultVoice`
    """
...
class InlineQueryResultDocument(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultDocument`
    """
...
class InlineQueryResultLocation(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultLocation`
    """
...
class InlineQueryResultVenue(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultVenue`
    """
...
class InlineQueryResultContact(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultContact`
    """
...
class InlineQueryResultGame(InlineQueryResultBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultGame`
    """
...
class InlineQueryResultCachedPhoto(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultCachedPhoto`
    """
...
class InlineQueryResultCachedGif(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultCachedGif`
    """
...
class InlineQueryResultCachedMpeg4Gif(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultCachedMpeg4Gif`
    """
...
class InlineQueryResultCachedSticker(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultCachedSticker`
    """
...
class InlineQueryResultCachedDocument(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultCachedDocument`
    """
...
class InlineQueryResultCachedVideo(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultCachedVideo`
    """
...
class InlineQueryResultCachedVoice(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultCachedVoice`
    """
...
class InlineQueryResultCachedAudio(InlineQueryResultCachedBase):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InlineQueryResultCachedAudio`
    """
...
class Animation(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.Animation`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class GameHighScore(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.GameHighScore`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class LabeledPrice(JsonSerializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.LabeledPrice`
    """
...
class Invoice(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.Invoice`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class ShippingAddress(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ShippingAddress`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class OrderInfo(JsonDeserializable):
    ...
    :type shipping_address: :class:`ReBot.types.ShippingAddress`

    :return: Instance of the class
    :rtype: :class:`ReBot.types.OrderInfo`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class ShippingOption(JsonSerializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ShippingOption`
    """
...
class SuccessfulPayment(JsonDeserializable):
    ...
    :type order_info: :class:`ReBot.types.OrderInfo`
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.SuccessfulPayment`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class ShippingQuery(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ShippingQuery`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class PreCheckoutQuery(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.PreCheckoutQuery`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class StickerSet(JsonDeserializable):
    ...
    :type stickers: :obj:`list` of :class:`ReBot.types.Sticker`

    :param thumb: Optional. Sticker set thumbnail in the .WEBP, .TGS, or .WEBM format
    :type thumb: :class:`ReBot.types.PhotoSize`

    :return: Instance of the class
    :rtype: :class:`ReBot.types.StickerSet`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class Sticker(JsonDeserializable):
    ...
    :type premium_animation: :class:`ReBot.types.File`

    :param mask_position: Optional. For mask stickers, the position where the mask should be placed
    :type mask_position: :class:`ReBot.types.MaskPosition`
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.Sticker`
    """
...
class MaskPosition(Dictionaryable, JsonDeserializable, JsonSerializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.MaskPosition`
    """
...
class InputPhoto(InputMedia):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InputMediaPhoto`
    """
    def __init__(self, media, caption=None, parse_mode=None):
        if util.is_pil_image(media):
            media = util.pil_image_to_file(media)
    
        super(InputPhoto, self).__init__(type="photo", media=media, caption=caption, parse_mode=parse_mode)

    def to_dict(self):
        return super(InputPhoto, self).to_dict()
...
class InputMediaVideo(InputMedia):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InputMediaVideo`
    """
...
class InputMediaAnimation(InputMedia):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InputMediaAnimation`
    """
    def __init__(self, media, thumb=None, caption=None, parse_mode=None, width=None, height=None, duration=None):
...
class InputMediaAudio(InputMedia):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InputMediaAudio`
    """
...
class InputMediaDocument(InputMedia):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.InputMediaDocument`
    """
...
class PollOption(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.PollOption`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class Poll(JsonDeserializable):
    ...
    :type options: :obj:`list` of :class:`ReBot.types.PollOption`
    ...
    :param explanation_entities: Optional. Special entities like usernames, URLs, bot commands, etc. that appear in 
        the explanation
    :type explanation_entities: :obj:`list` of :class:`ReBot.types.MessageEntity`
    ...
    def add(self, option):
        ...
        :type option: :class:`ReBot.types.PollOption` or :obj:`str`
        """
...
class PollAnswer(JsonSerializable, JsonDeserializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.PollAnswer`
    """
    @classmethod
    def de_json(cls, json_string):
        if (json_string is None): return None
...
class ChatLocation(JsonSerializable, JsonDeserializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ChatLocation`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return json_string
...
class ChatInviteLink(JsonSerializable, JsonDeserializable, Dictionaryable):
    ...
    :type creator: :class:`ReBot.types.User`
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ChatInviteLink`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class ProximityAlertTriggered(JsonDeserializable):
    ...
    :type traveler: :class:`ReBot.types.User`

    :param watcher: User that set the alert
    :type watcher: :class:`ReBot.types.User`

    :param distance: The distance between the users
    :type distance: :obj:`int`

    :return: Instance of the class
    :rtype: :class:`ReBot.types.ProximityAlertTriggered`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class VideoChatScheduled(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.VideoChatScheduled`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class VideoChatEnded(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.VideoChatEnded`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class VideoChatParticipantsInvited(JsonDeserializable):
    ...
    :type users: :obj:`list` of :class:`ReBot.types.User`

    :return: Instance of the class
    :rtype: :class:`ReBot.types.VideoChatParticipantsInvited`
    """
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class MessageAutoDeleteTimerChanged(JsonDeserializable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.MessageAutoDeleteTimerChanged`
    """   
    @classmethod
    def de_json(cls, json_string):
        if json_string is None: return None
...
class MenuButtonCommands(MenuButton):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.MenuButtonCommands`
    """
...
class MenuButtonWebApp(MenuButton):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.MenuButtonWebApp`
    """
...
class MenuButtonDefault(MenuButton):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.MenuButtonDefault`
    """
    def __init__(self, type):
        self.type: str = type
...
class ChatAdministratorRights(JsonDeserializable, JsonSerializable, Dictionaryable):
    ...
    :return: Instance of the class
    :rtype: :class:`ReBot.types.ChatAdministratorRights`
    """
...
class InputFile:
    ...
    .. code-block:: python3
        ...
        from ReBot.types import InputFile
