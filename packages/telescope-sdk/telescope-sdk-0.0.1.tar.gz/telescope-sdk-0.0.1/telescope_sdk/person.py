...
@dataclass_json
@dataclass
class Person(TelescopeBaseType):
    first_name: str
    last_name: str
    ...
    def from_pdl(pdl_input: dict[str, any]) -> Optional[Person]:
        ...
        return Person(
            ...
            languages=[Language.from_dict(language) for language in pdl_input.get('languages', [])],
            location=Location(
