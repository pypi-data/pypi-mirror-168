...
class DatabaseManagement(Base):
    ...
    def read_sql_query(self, table_id=None, query_function=None, pk_column=None, meta=None):
        ...
        if meta[pk_column] == 'str':
            ...
            ddf = dd.read_sql_query(sql=query_function(), con=con_str, index_col=pk_column, meta=df_meta, divisions=possible_divisions)
        else:
            ddf = dd.read_sql_query(sql=query_function(), con=con_str, index_col=pk_column, meta=df_meta, bytes_per_chunk="100 MB")
