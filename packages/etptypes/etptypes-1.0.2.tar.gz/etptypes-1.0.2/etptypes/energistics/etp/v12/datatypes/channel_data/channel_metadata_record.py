...
""" avro python class for file: channel_metadata_record """
...
class ChannelMetadataRecord(ETPModel):
    ...
    channel_class_uri: str = Field(alias="channelClassUri")

    status: ActiveStatusKind = Field(alias="status")

    source: str = Field(alias="source")

    axis_vector_lengths: typing.List[Strict[int]] = Field(alias="axisVectorLengths")
