...
""" avro python class for file: request_session """
...
class RequestSession(ETPModel):
    ...
    requested_protocols: typing.List[SupportedProtocol] = Field(
        alias="requestedProtocols"
    )
