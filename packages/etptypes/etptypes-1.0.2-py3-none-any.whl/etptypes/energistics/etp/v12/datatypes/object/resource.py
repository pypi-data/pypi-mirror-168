...
""" avro python class for file: resource """
...
class Resource(ETPModel):

    uri: str = Field(alias="uri")

    name: str = Field(alias="name")

    source_count: typing.Optional[Strict[int]] = Field(alias="sourceCount")

    target_count: typing.Optional[Strict[int]] = Field(alias="targetCount")
    ...
    alternate_uris: typing.List[Strict[str]] = Field(
        alias="alternateUris", default_factory=lambda: []
    )
