...
from pkulast.raster import pixelgrid
from pkulast.raster.parallel.jobmanager import find_executable
...
class InputCollection(object):
    ...
    def resampleToReference(self, ds, nullValList, workingRegion, resamplemethod, 
        ...
        if gdalwarp_path is None:
            ...
            raise GdalWarpNotFoundException(msg)
