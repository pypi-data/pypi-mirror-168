...
from pkulast.raster import inputcollection
from pkulast.raster import readerinfo
...
class ImageIterator(object):
    ...
    def __next__(self):
        ...
        except OutsideImageBoundsException:
            raise StopIteration()
    ...
    **Example**
    ...
    def prepare(self, workingGrid=None):
        ...
        if not self.inputs.checkAllMatch():
            ...
            raise ResampleNeededException(msg)
    ...
    def readBlock(self,nblock):
        ...
        if nblock >= (xtotalblocks * ytotalblocks):
            raise OutsideImageBoundsException()
