...
def readColumnFromBand(gdalBand, colName):
    ...
    if colArray is None:
        ...
        raise AttributeTableColumnException(msg)
...
def writeColumnToBand(gdalBand, colName, sequence, colType=None, 
    ...
    if colType is None:
        ...
        raise AttributeTableTypeException(msg)
...
def getColorTable(imgFile, bandNumber=1):
    ...
    if colorTable is None:
        raise AttributeTableColumnException("Image has no color table")
...
def setColorTable(imgfile, colorTblArray, layernum=1):
    ...
    if len(arrayShape) != 2:
        raise ArrayShapeException("ColorTableArray must be 2D. Found shape %s instead"%arrayShape)
    ...
    if numCols == 4:
        ...
        raise ArrayShapeException("Color table array has %d columns, expecting 4 or 5"%numCols)
...
def genColorTable(numEntries, colortype):
    ...
    if colortype == "rainbow":
        ...
        raise ColorTableGenerationException("Unknown colortype '{}'".format(colortype))
    return clrTbl
