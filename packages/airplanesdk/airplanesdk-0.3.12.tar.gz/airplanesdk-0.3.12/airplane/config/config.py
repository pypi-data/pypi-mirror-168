...
def workflow(
    ...
    The workflow's parameters are deduced from the function's arguments and type hints.
    ...
    Example:
        ...
        Sample workflow with parameter annotation::
    ...
    Args:
        ...
        allow_self_approvals:
            Whether or not this workflow allows self approvals.
        timeout:
            How long a workflow can run (in seconds) for before it is automatically cancelled.
        constraints:
